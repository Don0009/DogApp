...
class ProximusNumberPortingFormFRController extends Controller
{
    /**
    ...
    {
        //
        $proximus = ProximusNumberPortingFormFR::all();
        return view('proximus.number_porting_fr.index', compact('proximus'));
    }
    ...
    {
        //
        return view('proximus.number_porting_fr.create');
