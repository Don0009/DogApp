...
class MobileApplication extends Model
{
    protected $fillable = [
        ...
        'the', 'signature', 'dealer_reference', 'agent', 'mob_num1',
        'current_payment_method1', 'current_sim_number1', 'name1', 'f_name1', 'customer_number1',
        'current_operator1', 'date1', 'signature1', 'mob_num2', 'current_payment_method2',
        'current_sim_number2', 'name2', 'f_name2', 'customer_number2', 'current_operator2',
        'date2', 'signature2', 'mob_num3', 'current_payment_method3', 'current_sim_number3',
        'name3', 'f_name3', 'customer_number3', 'current_operator3', 'date3',
        'signature3', 'mob_num4', 'current_payment_method4', 'current_sim_number4', 'name4',
        'f_name4', 'customer_number4', 'current_operator4', 'date4', 'signature4',
        'mob_num5', 'current_payment_method5', 'current_sim_number5', 'name5', 'f_name5',
        'customer_number5', 'current_operator5', 'date5', 'signature5'
