...
class EngieContract extends Model
{
    ...
    ,'btw_be','rpr','company_name_1','legal_form_1','name_1','first_name_1','street','no','bus','postcode','place','electrabel_sa_1','electrabel_sa_2'
    ...
    ,'only_professional_use','in_case_of_moving_house','you_already_have_contract','you_do_not_yet','you_have_never_had_energy','clear_selection'
