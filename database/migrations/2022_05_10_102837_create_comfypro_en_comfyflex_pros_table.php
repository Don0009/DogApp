...
class CreateComfyproEnComfyflexProsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('comfypro_en_comfyflex_pros', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('comfypro_en_comfyflex_pros');
    }
}
