...
class CreateComfyProContractsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('comfy_pro_contracts', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('want_luminus_1')->nullable();
            $table->string('existing_connection_1')->nullable();
            ...
            $table->string('digitale')->nullable();
            $table->string('domiciliering')->nullable();
            $table->string('advance_invoices')->nullable();
            $table->string('my_advance_invoices')->nullable();
            $table->string('transfer')->nullable();
            $table->string('payment_for_electricity');
            $table->string('advance_gas');
            ...
            $table->string('personen')->nullable();
            $table->string('emails_or_text_messages')->nullable();
    ...
    {
        Schema::dropIfExists('comfy_pro_contracts');
    }
}
