...
class CreateOrangeInternetTvsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('orange_internet_tvs', function (Blueprint $table) {
            ...
            $table->boolean('one')->nullable();
            $table->boolean('two')->nullable();
            $table->boolean('three')->nullable();
            $table->boolean('and')->nullable();
            $table->boolean('neen')->nullable();
            ...
            $table->boolean('immediately_2')->nullable();
            $table->boolean('on_the_installation_date_2')->nullable();
            $table->string('call_number_6');
            $table->string('transfer_to_orange_4')->nullable();
            $table->string('stop_2')->nullable();
            ...
            $table->boolean('installation_date_3')->nullable();
            $table->string('call_number_7');
            $table->string('transfer_to_orange_2')->nullable();
            ...
            $table->boolean('on_the_installation_date_5')->nullable();
