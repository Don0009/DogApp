    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Mobile Number Porting</li>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form class="d-inline-block"
                                                action="{{ route('number_porting_du.destroy', $numdu->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                            ...
                                            {{-- <a href="{{ route('number_porting_du.edit', $numdu->id) }}"
