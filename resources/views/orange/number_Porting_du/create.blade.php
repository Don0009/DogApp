                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h5>
                                <bold>Gelieve steeds een recto verso kopie van de identiteitskaart (ook in geval van een voorafbetaalde kaart) en in geval van een
                                    rechtspersoon een kopie van de statuten van de firma bĳ te voegen</bold>
                            </h5>
                            <h4>Ik vraag aan Orange volgende nummers naar Orange over te dragen</h4>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-7">
                        ...
                        <div class="col-5">
                            <div class="card">
                                <div class="card-header">
                                    <h4>Gegevens nieuwe simkaart</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-6">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="mb-2">
                                                <label for="temp_mobile_no_1" class="form-label">Tĳdelĳk gsm-nr<span class="text-danger">*</span></label>
                                            ...
                                            <div class="mb-2">
                                                <label for="chosen_formula_1" class="form-label">Gekozen formule<span class="text-danger">*</span></label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" aria-describedby="basic-addon1" name="num_mobile_2">
                                            </div>
                                        </div>
                                        <div class="col-4">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="mb-2">
                                                <label for="temp_mobile_no_2" class="form-label">Tĳdelĳk gsm-nr<span class="text-danger">*</span></label>
                                            ...
                                            <div class="mb-2">
                                                <label for="chosen_formula_2" class="form-label">Gekozen formule<span class="text-danger">*</span></label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="num_mobile_3" class="form-control" aria-describedby="basic-addon1" name="num_mobile_3">
                                            </div>
                                        </div>
                                        <div class="col-4">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="mb-2">
                                                <label for="temp_mobile_no_3" class="form-label">Tĳdelĳk gsm-nr<span class="text-danger">*</span></label>
                                            ...
                                            <div class="mb-2">
                                                <label for="chosen_formula_3" class="form-label">Gekozen formule<span class="text-danger">*</span></label>
                    ...
                    <h6>*U dient het klantnummer enkel te vermelden indien het verschilt van het eerder vermelde klantnummer. Er is geen klantnummer bĳ een voorafbetaalde kaart.</h6>
                    <h5>De klant vraagt aan Orange in zĳn naam het (de) hierboven vernoemde contract(en) met de bestaande operator te
                        beëindigen, en het (de) eraan gerelateerde MSISDN-nummer(s) over te dragen.</h5>
                    <div class="row">
                        <div class="col-8">
                            <div class="card">
                                <div class="card-body">
                                    <p>De klant is ingelicht dat de overdracht van zĳn nummer naar Orange Belgium nv hem niet ontslaat van zĳn
                                        verplichting om zĳn overeenkomst met de vorige operator te respecteren tot aan de vervaldatum.</p>
                                    <p>Orange Belgium nv zal de wettelĳke bepalingen betreffende de nummeroverdracht naleven. Orange Belgium nv zal
                                        al de noodzakelĳke middelen in werking stellen teneinde de door de klant gevraagde overdracht tot stand te
                                        brengen. Orange Belgium nv kan echter niet verantwoordelĳk gesteld worden indien de overdracht niet uitgevoerd is
                                        voor redenen afhankelĳk van de voorgaande operator of van de klant. In het bĳzonder, is Orange Belgium nv niet
                                        verantwoordelĳk ingeval van valse, onvolledige, onjuiste of onleesbare overdrachtsaanvraag. De klant erkent een
                                        overeenkomst en de algemene voorwaarden van Orange Belgium nv te hebben gekregen en deze te aanvaarden</p>
                                    <p>
                                        <bold>Als de klant een consument is en het contract is op afstand gesloten of buiten de verkoopruimten van
                                            Orange Belgium nv of van haar erkende handelsagenten, heeft de klant het recht om dit contract zonder
                                            opgave van redenen te herroepen. De herroepingstermĳn verstrĳkt 14 dagen na de dag van de contractsluiting (bĳ een dienstencontract) of van de levering van het product (bĳ de verkoop van goederen). Om te
                                            herroepen kan de klant contact opnemen met de klantendienst op 5000 (gratis nummer via een Orange-gsm)
                                            of 02 745 95 00 met een ander toestel, (lokaal tarief) of zĳn beslissing per e-mail verzenden naar
                                            mobile_shop@orange.be of per post naar Orange Belgium nv Klantendienst, Postbus 950 B-1140 Brussel. De
                                            klant kan hiervoor, zonder verplichting, gebruikmaken van het modelformulier voor herroeping, beschikbaar
                                            op www.orange.be. Als de klant heeft gevraagd om de verrichting van diensten tĳdens de herroepingstermĳn te laten beginnen, moet hĳ een bedrag betalen dat evenredig is aan hetgeen reeds geleverd is op het
                                            moment dat hĳ Orange Belgium nv over de uitoefening van het herroepingsrecht informeert.</bold>
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-2">
                                        ...
                                        <label for="customer_sig" class="form-label">Handtekening van de klant:<span class="text-danger">*</span></label>
