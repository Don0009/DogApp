                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="authorized_represent"
                                        ...
                                        name="authorized_represent" value="{{ old('authorized_represent') }}" required>
                                </div>
                                <h5>
                                            ...
                                            <div class="col-10">
                                                <div class="mb-2">
                                                    <input type="sim_card_1"
                                                        ...
                                                        name="sim_card_1" value="{{ old('sim_card_1') }}" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-10">
                                                <div class="mb-2">
                                                    <input type="customer_no_1"
                                                        ...
                                                        name="customer_no_1" value="{{ old('customer_no_1') }}" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-10">
                                                <div class="mb-2">
                                                    <input type="customer_no_3"
                                                        ...
                                                        name="customer_no_3" value="{{ old('customer_no_3') }}" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
