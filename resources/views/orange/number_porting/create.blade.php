                     ...
                     <div class="card-body">
                         ...
                         <div class="row">
                             <div class="row col-md-3">
                                 <h6 style="color: orangered;" class="mr-3">Langue:<span class="text-danger">*</span></h6>
                                 <input type="radio" name="language" value="0">
                                 <label for="language" class="form-label ml-1">NL</label>
                                 <input type="radio" name="language" value="1">
                                 <label for="language" class="form-label ml-1">FR</label>
                             </div>
                             <div class="row col-md-6">
                                 <h5 style="color: orangered;">Titre:<span class="text-danger">*</span></h5>
                                 <input type="radio" name="title" class="ml-1" value="0">
                                 <label for="title" class="mr-2  ml-1 form-label">Mme</label>
                                 <input type="radio" name="title" class="ml-1" value="1">
                                 <label for="title" class="mr-2 ml-1 form-label">Mlle</label>
                                 <input type="radio" name="title" class="ml-1" value="2">
                                 <label for="title" class="mr-2 ml-1 form-label">M</label>
                             </div>
                         </div>
                         <div class="row">
                             <h5 class="mr-3 mt-2" style="color:orangered;">Type de client:<span class="text-danger">*</span></h5>
                             <input class="mt-2  ml-1" type="radio" name="customer_type" value="0">
                             <label class="mt-2" for="customer_type" class="form-label ml-1">Personne physique</label>
                             <input class="mt-2 ml-1" type="radio" name="customer_type" value="1">
                             <label class="mt-2" for="customer_type" class="form-label ml-1">Indépendant/profession
                                 libérale</label>
                         </div>
                         <div class="row">
                             <div class="col-6">
                         ...
                         <div style="float: left;" class="col-4">
                             ...
                             <div class="mb-2">
                                 <label for="date" class="mt-3 form-label">Le:<span class="text-danger">*</span></label>
