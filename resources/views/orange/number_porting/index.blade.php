                    ...
                    <table id="dataTableExample" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form class="d-inline-block" action="{{ route('number_porting.destroy',$num->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                    ...
                                    <a href="{{ route('number_porting.edit',$num->id) }}" class="btn btn-warning btn-icon-text">
