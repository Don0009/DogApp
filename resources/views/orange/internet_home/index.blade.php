                    ...
                    <table id="dataTableExample" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form class="d-inline-block" action="{{ route('internet_home.destroy',$home->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                    ...
                                    <a href="{{ route('internet_home.edit',$home->id) }}" class="btn btn-warning btn-icon-text">
