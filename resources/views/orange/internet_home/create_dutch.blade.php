                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <h6>Taal:<span class="text-danger">*</span>
                                            <h6>
                                    ...
                                    <div class="col-3">
                                        <div class="mb-2">
                                            ...
                                            <input type="no" class="form-control @error('no') is-invalid @enderror" id="no"
                                                autocomplete="off" placeholder="N°" name="no" value="{{ old('no') }}"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                ...
                                <div class="mb-3">
                                    <label for="mail" class="form-label">E Mail<span
                                            class="text-danger">*</span></label>
                                    <input type="mail" class="form-control @error('mail') is-invalid @enderror" id="mail"
                                        autocomplete="off" placeholder="Mail" name="mail" value="{{ old('mail') }}"
                                        required>
                                    @error('mail')
                                        <span class="invalid-feedback mb-3" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="row">
                                    <h5>Facturatieadres (indien verschillend van het adres van de klant)</h5>
                                </div>
                                <div class="row">
                                    <div class="col-6">
                                        <div class="mb-2">
                                    ...
                                    <div class="col-3">
                                        <div class="mb-2">
                                            ...
                                            <input type="comp_no"
                                                ...
                                                autocomplete="off" placeholder="N°" name="comp_no"
                                    ...
                                    <div class="col-3">
                                        <div class="mb-2">
                                            ...
                                            <input type="comp_box"
                                                ...
                                                autocomplete="off" placeholder="Bte" name="comp_box"
                                ...
                                <div class="row">
                                    <div class="col-12 mb-3">
                                        ...
                                        <input type="card_number"
                                            ...
                                            id="card_number" autocomplete="off" placeholder="Simkaartnr" name="card_number"
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <label for="copy" class="form-label">Opgemaakt in 3 exemplaren te:<span
                                                    class="text-danger">*</span></label>
                                            <input type="copy" class="form-control @error('copy') is-invalid @enderror"
                                                id="copy" autocomplete="off" placeholder="Fait en 3 exemplaires à"
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <p>. Deze abonnementsaanvraag heeft slechts waarde en verbindt Orange Belgium nv
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <h5>Betaling met kredietkaart</h5>
                                            <p> Hierb
                                                ĳ geef ik Orange Belgium nv de toestemming om tot uitdrukkel ĳke herroeping,
                                                alle facturen met betrekking tot dit contract te debiteren van de rekening
                                                van
                                            ...
                                            <label for="card_expiration_date" class="form-label">Vervaldatum van de
                                            ...
                                            <input
                                                ...
                                                data-inputmask="'alias': 'datetime'" data-inputmask-inputformat="dd/mm/yyyy"
                                                inputmode="numeric" id="card_expiration_date" name="card_expiration_date"
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p>Door dit mandaat te ondertekenen, geef je toestemming aan Orange Belgium nv
                                    BE12ZZZ0456810810 een opdracht te sturen naar je bank om een bedrag van je rekening te
                                    debiteren, en aan je bank om een bedrag van je rekening te debiteren in overeenstemming
                                    met de opdracht van Orange Belgium nv BE12ZZZ0456810810. De prenoti
                                    ficatie,bepaald in de Europese Richtl ĳn betre ffende de betalingsdiensten,wordt
                                    meegedeeld via de factuur die je kan worden
                                    toegezonden binnen minder dan de 14 dagen vastgelegd in de Richtl ĳn. Je hebt het recht
                                    op terugbetaling door je bank volgens de
                                    voorwaarden die in je overeenkomst met de bank z ĳn vastgelegd. Je moet je verzoek
                                    tot terugbetaling indienen binnen de 8 weken na de datum waarop het bedrag van je
                                    rekening werd gedebiteerd. </p>
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="account_holder_name"
                                        ...
                                        id="account_holder_name" autocomplete="off" placeholder="Naam van de rekeninghouder"
                                ...
                                <div class="row">
                                    <div class="col-10">
                                        ...
                                        <input type="postal_code_and_city"
                                            ...
                                            id="postal_code_and_city" autocomplete="off" placeholder="Postcode en gemeente"
                                            name="postal_code_and_city" value="{{ old('postal_code_and_city') }}"
                                            required>
                                    </div>
                                    <div class="col-2">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <input
                                                    ...
                                                    data-inputmask-inputformat="dd/mm/yyyy" inputmode="numeric" id="a_date"
                                                    name="a_date" value="{{ old('a_date') }}" type="date">
