                ...
                <div class="col-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <label for="client_num" class="form-label">Klantnr<span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                <p>
                                    ...
                                    www.orange.be. Als de klant heeft gevraagd om de verrichting van diensten tĳdens de herroepingstermĳn te laten beginnen, moet hĳ een bedrag betalen dat
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <label for="copy" class="form-label">Opgemaakt in 3 exemplaren te:<span class="text-danger">*</span></label>
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <p>. Deze abonnementsaanvraag heeft slechts waarde en verbindt Orange Belgium nv voor zover de hierin voorkomende vermeldingen juist en
                                            volledig z ĳn. De klant verbindt er zich toe elke w ĳziging onmiddell ĳk schriftel
                                        ...
                                        <p>. Orange Belgium nv behoudt zich het recht voor om na onderzoek van het dossier de door de klant gevraagde dienst(en) te beperken,
                                            overeenkomstig de algemene abonnementsvoorwaarden van Orange Belgium nv. Orange Belgium nv verbindt zich ertoe de klant schriftel ĳ k
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <label for="card_expiration_date" class="form-label">Vervaldatum van de kredietkaart:<span class="text-danger">*</span></label>
