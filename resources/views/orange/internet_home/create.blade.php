                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-2">
                                    <input type="checkbox" name="internet_home_boot_option" value="0" required>
                                ...
                                <div class="col-12">
                                    <div class="mb-2">
                                        <input type="checkbox" name="internet_home_boot_option" value="" required>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="mb-2">
                                            <label for="street" class="form-label">Rue:<span class="text-danger">*</span></label>
                                            <input type="street" class="form-control @error('street') is-invalid @enderror" id="street" autocomplete="off" placeholder="Rue" name="main_address_street" value="{{ old('main_address_street') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="mb-2">
                                            <label for="no" class="form-label">N°:<span class="text-danger">*</span></label>
                                            <input type="no" class="form-control @error('no') is-invalid @enderror" id="no" autocomplete="off" placeholder="N°" name="main_address_no" value="{{ old('main_address_no') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="mb-2">
                                            <label for="box" class="form-label">Bte:<span class="text-danger">*</span></label>
                                            <input type="box" class="form-control @error('box') is-invalid @enderror" id="box" autocomplete="off" placeholder="Bte" name="main_address_box" value="{{ old('main_address_box') }}" required>
                                        </div>
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="mb-2">
                                        <label for="town" class="form-label">Ville<span class="text-danger">*</span></label>
                                        <input type="town" class="form-control @error('town') is-invalid @enderror" id="town" autocomplete="off" placeholder="Ville" name="main_address_town" value="{{ old('main_address_town') }}" required>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="mb-2">
                                        <label for="postal_code" class="form-label">Code postal:<span class="text-danger">*</span></label>
                                        <input type="postal_code" class="form-control @error('postal_code') is-invalid @enderror" id="postal_code" autocomplete="off" placeholder="Code postal" name="main_address_postal_code" value="{{ old('main_address_postal_code') }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-2">
                                        ...
                                        <div class="form-group">
                                            <textarea name="date_signature_customer" class="form-control" id="exampleFormControlTextarea3" rows="6" required></textarea>
                                ...
                                <div class="col-12">
                                    <div class="mb-2">
                                        ...
                                        <label for="card_expiration_date" class="form-label">Date d’expiration de
                                        ...
                                        <label for="code_generate" class="form-label">Code / alias généré par Ogone
                                    ...
                                    <label for="date_signature_customer" class="mt-2">Signature du client
                                        :</label>
                                    <div class="form-group">
                                        <textarea name="date_signature_customer_2" class="form-control" id="exampleFormControlTextarea3" rows="6" required></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-3 mr-3 card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        <div class="mb-2">
                                            <label for="bic_code" class="mt-3 form-label">Code BIC<span class="text-danger">*</span></label>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="mb-2">
                                                    ...
                                                    <label for="location" class="mt-3 form-label">Lieu<span class="text-danger">*</span></label>
