                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="client_num" class="form-control @error('client_num') is-invalid @enderror"
                                        id="client_num" autocomplete="off" placeholder="N° de client" name="client_num"
                                ...
                                <div class="mb-2">
                                    ...
                                    <label for="new_client" class="form-label">Nouveau clien<span
                                            class="text-danger">*</span></label>
                                    @error('new_client')
                                        <span class="invalid-feedback mb-2" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="mb-2">
                                    <label for="account_number" class="form-label">N° de compte<span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="company_name"
                                        ...
                                        autocomplete="off" placeholder="Nom de la société" name="company_name"
                                    ...
                                    <div class="col-12">
                                        <div class="mb-2">
                                            ...
                                            <input type="code_generate"
                                                ...
                                                id="credit_card_holder" autocomplete="off"
                                                placeholder="Code / alias généré par Ogone / Inginéco" name="code_generate"
