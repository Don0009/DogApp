    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-description">All Mobile Phone here.</p>
                    ...
                    <table id="dataTableExample" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form class="d-inline-block" action="{{ route('mobile_phone.destroy',$phone->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                    ...
                                    <a href="{{ route('mobile_phone.edit',$phone->id) }}" class="btn btn-warning btn-icon-text">
