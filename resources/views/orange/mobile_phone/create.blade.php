                                ...
                                <div class="container">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <label for="code_generate" class="mt-2 form-label">Code / alias généré par
                                                Ogone /
                                    ...
                                    {{-- paste signx here --}}
                                    <label for="sign_1" class="form-label">Signature du client:<span
                                            class="text-danger">*</span></label>
                                    ...
                                    <div class="">
                                        ...
                                        <div class="row">
                                            <div class="ml-3 mt-3 col-9">
                                                <label for="iban_account_number" class="form-label">N° de compte
