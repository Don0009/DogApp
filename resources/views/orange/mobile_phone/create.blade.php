                    ...
                    <div class="col-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <label for="client_num" class="form-label">N° de client: 1 -<span
                                            class="text-danger">*</span></label>
                                    <input type="client_num" class="form-control @error('client_num') is-invalid @enderror"
                                        id="client_num" autocomplete="off" placeholder="Client Number" name="client_num"
                                ...
                                <div class="row">
                                    <h5 style="color: orangered;">Type de client:<span class="text-danger">*</span></h5>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="name" class="form-control @error('name') is-invalid @enderror" id="name"
                                        autocomplete="off" placeholder="Name" name="name" value="{{ old('name') }}"
                                        required>
                                    @error('name')
                                        <span class="invalid-feedback mb-3" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <h5 class="mb-3" style="color: orangered;">Adresse de facturation (si différente
                                    ...
                                    <div class="col-3">
                                        <div class="mb-2">
                                            ...
                                            <input type="comp_no"
                                                ...
                                                autocomplete="off" placeholder="Comp_No" name="comp_no"
                                    ...
                                    <div class="col-3">
                                        <div class="mb-2">
                                            ...
                                            <input type="comp_box"
                                                ...
                                                autocomplete="off" placeholder="Comp Box" name="comp_box"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="mb-2">
                                            <label for="comp_postal_code" class="form-label">Code Postale<span
                                                    class="text-danger">*</span></label>
                                    ...
                                    <div class="col-6">
                                        <div class="mb-2">
                                            ...
                                            <input type="comp_town"
                                                ...
                                                id="comp_town" autocomplete="off" placeholder="Comp Town" name="comp_town"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="comp_country"
                                        ...
                                        autocomplete="off" placeholder="Comp Country" name="comp_country"
                    ...
                    <div class="col-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <label for="res_number" class="form-label">Numéro Réservé<span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="mb-3">
                                    <label for="pricing_plan" class="form-label">Plan Tarifaire<span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        <h5 class="mb-3" style="color: orangered;">Signature du client (titulaire
                                            de la carte principale
                                        </h5>
                                        <label for="copy" class="form-label">Fait en 2 exemplaires à :<span
                                                class="text-danger">*</span></label>
                                ...
                                {{-- <p>. Cette demande de contrat est valable et lie Orange Belgium s.a. sous condition que
                                    toutes les informations mentionnées soient correctes et
                                    complètes. Le client s’engage à informer immédiatement Orange Belgium s.a. de tout
                                    changement par écrit.</p> --}}
                                {{-- <p> .Orange Belgium s.a. se réserve le droit de limiter le(s) service(s) demandé(s) par le
                                    client après examen du dossier, conformément aux
                                    conditions générales d’Orange Belgium s.a. Orange Belgium s.a. s’engage à informer, par
                                    écrit, le client du résultat de cette demande de
                                    contrat. </p> --}}
                                <div class="col-12">
                                    <div class="mb-3">
                                        <h5 class="mt-3 mb-3" style="color: orangered;">Paiement par carte de crédit
                                        </h5>
                                        ...
                                        <label for="code_generate" class="mt-2 form-label">Code / alias généré par Ogone /
