        ...
        <div class="col-md-12">
            <form class="forms-sample" action="{{ route('mobile_phone.store') }}" method="POST">
                    ...
                    <div class="col-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <label for="client_num" class="form-label">Klantnr. : 1<span
                                            class="text-danger">*</span></label>
                                    <input type="client_num" class="form-control @error('client_num') is-invalid @enderror"
                                        id="client_num" autocomplete="off" placeholder="Klantnr" name="client_num"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="exist_phone"
                                        ...
                                        autocomplete="off" placeholder="GSM-nr" name="exist_phone"
                                ...
                                <div class="row">
                                    ...
                                    <input type="radio" name="customer_type" value="0" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="name" class="form-control @error('name') is-invalid @enderror" id="name"
                                        autocomplete="off" placeholder="Naam" name="name" value="{{ old('name') }}"
                                        required>
                                    @error('name')
                                        <span class="invalid-feedback mb-3" role="alert">
                                            <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-3">
                                        <div class="mb-2">
                                            ...
                                            <input type="no" class="form-control @error('no') is-invalid @enderror" id="no"
                                                autocomplete="off" placeholder="Nr" name="no" value="{{ old('no') }}"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                    ...
                                    <div class="col">
                                        <div class="mb-2">
                                            ...
                                            <input type="town" class="form-control @error('town') is-invalid @enderror"
                                                id="town" autocomplete="off" placeholder="Stad" name="town"
                                    ...
                                    <div class="col-6">
                                        <div class="mb-2">
                                            ...
                                            <input type="country"
                                                ...
                                                autocomplete="off" placeholder="Land" name="country"
                                    ...
                                    <div class="col-6">
                                        <div class="mb-2">
                                            ...
                                            <input type="company_number"
                                                ...
                                                id="company_number" autocomplete="off" placeholder="Ondernemingsnr"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="company_name"
                                        ...
                                        autocomplete="off" placeholder="Firmanaam" name="company_name"
                                    ...
                                    <div class="col-6">
                                        <div class="mb-2">
                                            ...
                                            <input type="comp_street"
                                                ...
                                                id="comp_street" autocomplete="off" placeholder="Straat" name="comp_street"
                                    ...
                                    <div class="col-3">
                                        <div class="mb-2">
                                            <label for="comp_no" class="form-label">Nr<span
                                                    class="text-danger">*</span></label>
                                            <input type="comp_no"
                                                class="form-control @error('comp_no') is-invalid @enderror" id="comp_no"
                                                autocomplete="off" placeholder="Nr" name="comp_no"
                                    ...
                                    <div class="col-3">
                                        <div class="mb-2">
                                            <label for="comp_box" class="form-label">Bus<span
                                                    class="text-danger">*</span></label>
                                            <input type="comp_box"
                                                class="form-control @error('comp_box') is-invalid @enderror" id="comp_box"
                                                autocomplete="off" placeholder="Bus" name="comp_box"
                                    ...
                                    <div class="col-6">
                                        <div class="mb-2">
                                            ...
                                            <input type="comp_postal_code"
                                                ...
                                                name="comp_postal_code" value="{{ old('comp_postal_code') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-2">
                                            ...
                                            <input type="comp_town"
                                                ...
                                                id="comp_town" autocomplete="off" placeholder="Plaats" name="comp_town"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="comp_country"
                                        ...
                                        autocomplete="off" placeholder="Land" name="comp_country"
                                ...
                                <div class="row">
                                    <p>
                                        ...
                                        dienstencontract) of van de levering van het product (bĳ de verkoop van goederen).
                                        Om
                                        te herroepen kan de klant contact opnemen met de klantendienst op 5000 (gratis
                                        nummer
                                        ...
                                        Belgium nv, Klantendienst, Postbus 950, B-1140 Brussel. De klant kan hiervoor,
                                        zonder
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="pricing_plan"
                                        class="form-control @error('pricing_plan') is-invalid @enderror" id="pricing_plan"
                                        autocomplete="off" placeholder="Comp Country" name="pricing_plan"
                                        value="{{ old('pricing_plan') }}" required>
                                    @error('pricing_plan')
                                        <span class="invalid-feedback mb-3" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="mb-3">
                                    <label for="options_services" class="form-label">Optie en diensten<span
                                            class="text-danger">*</span></label>
                                ...
                                <p>
                                    Gelieve steeds een recto verso kopie van de identiteitskaart en in geval van een
                                    rechtspersoon een kopie
                                    van de statuten van de firma bij te voegen
                                </p>
                                <h5>Handtekening klant : ..X...............</h5>
                                <p>• Deze abonnementsaanvraag heeft slechts waarde en verbindt Orange Belgium nv voor zover
                                    de hierin voorkomende vermeldingen juist en
                                    volledig zĳn. De klant verbindt er zich toe elke wĳziging onmiddellĳk schriftelĳk te
                                    melden aan Orange Belgium nv</p>
                                <p>. Orange Belgium nv behoudt zich het recht voor om na onderzoek van het dossier de door
                                    de klant gevraagde dienst(en) te beperken,
                                    overeenkomstig de algemene abonnementsvoorwaarden van Orange Belgium nv. Orange Belgium
                                    nv verbindt zich ertoe de klant schriftelĳk
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <p> Hierbĳ geef ik Orange Belgium nv de toestemming om tot uitdrukkelĳke herroeping,
                                            alle facturen met betrekking tot dit contract te debiteren van de rekening van
                                            volgende
                                            kredietkaart :</p>
                                        ...
                                        <input type="credit_card_holder"
                                            ...
                                            name="credit_card_holder" value="{{ old('credit_card_holder') }}" required>

                                        <label for="code_generate" class="form-label">Code / alias gegenereerd door
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <h5>Mandaat SEPA Europese domiciliëring – Business to consumer (CORE) voor een terugkerende
                                invordering.</h5>
                            <p>Mandaatreferentie (UMR): Deze referentie zal je meegedeeld worden op je factuur</p>
                            <p>Door dit mandaat te ondertekenen, geef je toestemming aan Orange Belgium nv BE12ZZZ0456810810
                                een opdracht te sturen naar je bank om een bedrag van je rekening te
                                debiteren, en aan je bank om een bedrag van je rekening te debiteren in overeenstemming met
                                de opdracht van Orange Belgium nv BE12ZZZ0456810810. De prenotificatie,
                                bepaald in de Europese Richtlijn betreffende de betalingsdiensten, wordt meegedeeld via de
                                factuur die je kan worden toegezonden binnen minder dan de 14 dagen
                                vastgelegd in de Richtlijn. Je hebt het recht op terugbetaling door je bank volgens de
                                voorwaarden die in je overeenkomst met de bank zijn vastgelegd. Je moet je verzoek
                                tot terugbetaling indienen binnen de 8 weken na de datum waarop het bedrag van je rekening
                                werd gedebiteerd.</p>
                            <h4>Ondergetekende,</h4>
                            <div class="mb-2">
                                <label for="account_holder_name" class="form-label">Naam van de rekeninghouder<span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-10">
                                    <label for="postal_code_and_city" class="form-label">Postcode en gemeente<span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="col-2">
                                    ...
                                    <input type="hold_country"
                                        class="form-control @error('hold_country') is-invalid @enderror" id="hold_country"
                                        autocomplete="off" placeholder="Nom du titulaire de compte" name="hold_country"
                                        value="{{ old('hold_country') }}" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-9">
                                    <label for="iban_account_number" class="form-label">IBAN-rekeningnummer<span
                                            class="text-danger">*</span></label>
                                    <input type="iban_account_number"
                                        class="form-control @error('iban_account_number') is-invalid @enderror"
                                        id="iban_account_number" autocomplete="off" placeholder="Nom du titulaire de compte"
                                        name="iban_account_number" value="{{ old('iban_account_number') }}" required>
                                </div>
                                <div class="col-3">
                                    <label for="bic_code" class="form-label">BIC-code<span
                                            class="text-danger">*</span></label>
                                    <input type="bic_code" class="form-control @error('bic_code') is-invalid @enderror"
                                        id="bic_code" autocomplete="off" placeholder="Nom du titulaire de compte"
                                        name="bic_code" value="{{ old('bic_code') }}" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-9">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <label for="a_date" class="form-label"> Datum (dag/maand/jaar)<span
                                                    class="text-danger">*</span></label>
                                            <input class="form-control @error('a_date') is-invalid @enderror mb-4 mb-md-0"
                                                ...
                                                type="date">
                                            <label for="location" class="form-label">Plaats<span
                                                    class="text-danger">*</span></label>
                                            <input type="location"
                                                class="form-control @error('location') is-invalid @enderror" id="location"
                                                autocomplete="off" placeholder="Nom du titulaire de compte" name="location"
                                ...
                                <div class="col-3">
                                    <label for="signature" class="form-label">Handtekening (rekeninghouder)<span
                                            class="text-danger">*</span></label>
                                    <textarea type="signature" class="form-control @error('signature') is-invalid @enderror" id="signature"
                                        ...
                                        name="signature" rows="8" value="{{ old('signature') }}" required></textarea>
                                </div>
