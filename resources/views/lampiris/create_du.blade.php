        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-5">
                        <label for="bank_account" class="form-label">Bankrekeningnummer<span class="text-danger">*</span></label>
                        <input type="text" class="form-control @error('bank_account') is-invalid @enderror" id="locality" autocomplete="off" placeholder="Bankrekeningnummer" name="bank_account" value="{{ old('bank_account') }}" required>
                        @error('bank_account')
                        <span class="invalid-feedback mb-2" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="col-3">
                        <label for="people" class="form-label">Aantal personen gedomicilieerd<span class="text-danger">*</span></label>
                        <input type="number" class="form-control @error('people') is-invalid @enderror" id="locality" autocomplete="off" placeholder="Aantal personen" name="people" value="{{ old('people') }}" required>
                    </div>
                </div>
                ...
                <div class="row mt-2">
                    <div class="col-8">
                        ...
                        <input type="text" class="form-control @error('adress') is-invalid @enderror" id="box" autocomplete="off" placeholder="Adres" name="adress" value="{{ old('adress') }}" required>
                        @error('adress')
                        <span class="invalid-feedback mb-2" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="col-4">
                        ...
                        <input type="text" class="form-control @error('box') is-invalid @enderror" id="box" autocomplete="off" placeholder="Bus" name="box" value="{{ old('box') }}" required>
                        @error('box')
                        <span class="invalid-feedback mb-2" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="row mt-2">
                    <div class="col-4">
                        ...
                        <input type="text" class="form-control @error('no') is-invalid @enderror" id="no" autocomplete="off" placeholder="Nr" name="no" value="{{ old('no') }}" required>
                        @error('no')
                        <span class="invalid-feedback mb-2" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="col-4">
                        ...
                        <input type="text" class="form-control @error('locality') is-invalid @enderror" id="locality" autocomplete="off" placeholder="Plaats" name="locality" value="{{ old('locality') }}" required>
                        @error('locality')
                        <span class="invalid-feedback mb-2" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="row mt-2">
                    <div class="col-8">
                        ...
                        <input type="text" class="form-control @error('adress1') is-invalid @enderror" id="adress1" autocomplete="off" placeholder="Adres" name="adress1" value="{{ old('adress1') }}" required>
                        @error('adress1')
                        <span class="invalid-feedback mb-2" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="col-4">
                        ...
                        <input type="text" class="form-control @error('box1') is-invalid @enderror" id="box1" autocomplete="off" placeholder="Bus" name="box1" value="{{ old('box1') }}" required>
                        @error('box1')
                        <span class="invalid-feedback mb-2" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="row mt-2">
                    <div class="col-4">
                        ...
                        <input type="text" class="form-control @error('no1') is-invalid @enderror" id="no" autocomplete="off" placeholder="Nr" name="no1" value="{{ old('no1') }}" required>
                        @error('no1')
                        <span class="invalid-feedback mb-2" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="col-4">
                        <label for="locality1" class="form-label">Plaats<span class="text-danger">*</span></label>
                        <input type="text" class="form-control @error('locality1') is-invalid @enderror" id="locality1" autocomplete="off" placeholder="Plaats" name="locality1" value="{{ old('locality1') }}" required>
                        @error('locality1')
                        <span class="invalid-feedback mb-2" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="row mt-2">
                    <div class="col-6">
                        <label for="annual_consu" class="form-label">Wat is uw jaarlijkse verbruik1? <span class="text-danger">*</span></label>
                ...
                <div class="row mt-2">
                    <div class="col-6">
                        <label for="current_provid" class="form-label">Huidige leverancier<span class="text-danger">*</span></label>
                        <input type="text" class="form-control @error('current_provid') is-invalid @enderror" id="current_provid" autocomplete="off" placeholder="Huidige leverancier" name="current_provid" value="{{ old('current_provid') }}" required>
                    ...
                    <div class="col-6">
                        <label for="start_date" class="form-label">Gewenste begindatum voor levering<span class="text-danger">*</span></label>
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-4">
                        <label for="counter" class="form-label">Meterstand<span class="text-danger">*</span></label>
                        <input type="text" class="form-control @error('counter') is-invalid @enderror" id="counter" autocomplete="off" placeholder="Meterstand" name="counter" value="{{ old('counter') }}" required>
                        @error('counter')
                        <span class="invalid-feedback mb-2" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="col-4">
                        <label for="annual_consu1" class="form-label">Wat is uw jaarlijkse verbruik1?<span class="text-danger">*</span></label>
                ...
                <div class="row mt-2">
                    <div class="col-6">
                        <label for="current_provid1" class="form-label">Huidige leverancier<span class="text-danger">*</span></label>
                        <input type="text" class="form-control @error('current_provid1') is-invalid @enderror" id="current_provid1" autocomplete="off" placeholder="Huidige leverancier" name="current_provid1" value="{{ old('current_provid1') }}" required>
                    ...
                    <div class="col-6">
                        <label for="start_date1" class="form-label">Gewenste begindatum voor levering2<span class="text-danger">*</span></label>
                ...
                <div class="row mt-2">
                    <div class="col-9">
                        <span>Ik schrijf me in op de nieuwsbrief van de groep Lampiris met onder andere informatie over de groep Lampiris, de energiemarkt, nuttige tips en wedstrijden:</span>
                    </div>
                    <div class="col-3">
                ...
                <div class="row mt-2">
                    <div class="col-6">
                        <label for="undersigned" class="form-label">Ik, ondergetekende<span class="text-danger">*</span></label>
                        <input type="text" class="form-control @error('undersigned') is-invalid @enderror" id="undersigned" autocomplete="off" placeholder="Ik, ondergetekende" name="undersigned" value="{{ old('undersigned') }}" required>
                        @error('undersigned')
                        <span class="invalid-feedback mb-2" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-4">
                        ...
                        <input type="text" class="form-control @error('the') is-invalid @enderror" id="the" autocomplete="off" placeholder="Plaats" name="the" value="{{ old('the') }}" required>
                        @error('the')
                        <span class="invalid-feedback mb-2" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-4">
                        ...
                        <input type="text" class="form-control @error('city') is-invalid @enderror" id="city" autocomplete="off" placeholder="Stad" name="city" value="{{ old('city') }}" required>
                        @error('city')
                        <span class="invalid-feedback mb-2" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-4 mb-2">
                        <label for="pricing_code" class="form-label">Tariefcode:<span class="text-danger">*</span></label>
                        <input type="text" class="form-control @error('pricing_code') is-invalid @enderror" id="city" autocomplete="off" placeholder="Tariefcode" name="pricing_code" value="{{ old('pricing_code') }}" required>
                        @error('pricing_code')
                        <span class="invalid-feedback mb-2" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
