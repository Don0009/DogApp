            ...
            <form action="{{ route('proximus_connection_request_du.store') }}" method="post">@csrf
                <div class="row">
                    ...
                    <div class="mb-2 mt-5 col-md-9">
                        ...
                        <label for="tv_packs_options" class="form-label">Flex (INT + TV + TEL) + (Wifi Booster + Family
                            life
                            Premium)</label>
                    </div>
                    ...
                    <div class="mb-2 mt-5   col-md-5">
                        ...
                        <label for="phone_line_package_types" class="form-label">Unlimited Calls National (inbegrepen in
                            Flex + Business Flex)</label>
                    </div>
                    <div class="mb-2 mt-3   col-md-12">

                        <input type="radio" name="phone_line_package_types" class="ml-2" value="4" required>
                        <label for="phone_line_package_types" class="form-label">Unlimited Calls National/International
                    ...
                    <div class="mb-2 mt-5   col-md-6">
                        ...
                        <input type="radio" name="optical_fibre_package_type" class="ml-2" value="0" required>
                    ...
                    <div class="mb-2 mt-5   col-md-6">
                        ...
                        <input type="radio" name="optical_fibre_package_type_3" class="ml-2" value="0" required>
                        <label for="optical_fibre_package_type_3" class="form-label">Ja</label>
                        <input type="radio" name="optical_fibre_package_type_3" class="ml-2" value="1" required>
                    ...
                    <div class="mb-2 mt-5   col-md-4">
                        ...
                        <label for="multi_line_license" class="form-label">2 licenties inbegrepen in een Pack </label>
                    </div>
                    ...
                    <div class="mb-2 mt-5   col-md-6">
                        ...
                        <label for="mob_tele_pack_type" class="form-label">Overdracht van Base/Orange/Telenet*</label>
                    </div>
                    ...
                    <div class="mb-2 mt-5 col-md-4">
                        ...
                        <input type="radio" name="existing_proximus_customer" class="ml-2" value="0" required>
                    ...
                    <div class="mb-2 mt-5   col-md-3">
                        ...
                        <span class="mr-2"><b>Taal</b></span> <input type="radio" name="lang" class="ml-2" value="0"
                            required>
                    ...
                    <div class="mb-2 mt-5   col-md-3">
                        ...
                        <input type="radio" name="residential_met_mobilus_limit_full" class="ml-2" value="0" required>
                        <label for="residential_met_mobilus_limit_full" class="form-label"> met Mobilus
                            FullControl</label>
                    </div>
                    <div class="mb-2 mt-5   col-md-3">

                        <input type="radio" name="residential_met_mobilus_limit_full" class="ml-2" value="1" required>
                        <label for="residential_met_mobilus_limit_full" class="form-label"> S </label>
                    </div>
                    <div class="mb-2 mt-5   col-md-3">

                        <input type="radio" name="residential_met_mobilus_limit_full" class="ml-2" value="2" required>
                        <label for="residential_met_mobilus_limit_full" class="form-label"> M</label>
                    </div>
                    <div class="mb-2 mt-5   col-md-3">

                        <input type="radio" name="residential_met_mobilus_limit_full" class="ml-2" value="3" required>
                    ...
                    <div class="mb-2 mt-5   col-md-4">
                        ...
                        <label for="joint_data_offer_p_i" class="form-label">DataPhone (500 MB) €4,13/maand excl. btw
                        </label>
                    </div>
                    <div class="mb-2 mt-5   col-md-4">
                    ...
                    <div class="mb-2 mt-5   col-md-4">
                        ...
                        <label for="joint_data_offer_p_i" class="form-label">DataPhone (1,5GB) €12,40/maand excl. btw
                        </label>
                    </div>
                    <div class="mb-2 mt-5   col-md-4">

                        <input type="radio" name="joint_data_offer_p_i" class="ml-2" value="4" required>
                        <label for="joint_data_offer_p_i" class="form-label">DataPhone (2 GB) € 16,53/maand excl. btw
                        </label>
                    </div>
                    <div class="mb-2 mt-5   col-md-4">

                        <input type="radio" name="joint_data_offer_p_i" class="ml-2" value="5" required>
                        <label for="joint_data_offer_p_i" class="form-label">DataPhone (2,5 GB) € 20,66/maand excl. btw
                        </label>
                    </div>
                    ...
                    <div class="mb-2 mt-5   col-md-4">
                        ...
                        <label for="mobile_social_apps_p_i" class="form-label"> <i data-feather="facebook"></i></label>
                    </div>
                    ...
                    <div class="mb-2 mt-5   col-md-4">
                        ...
                        <label for="mobile_social_apps_p_i" class="form-label"> <i data-feather="twitter"></i></label>
                    </div>
                    <div class="mb-2 mt-5   col-md-4">

                        <input type="radio" name="mobile_social_apps_p_i" class="ml-2" value="2" required>
                        <label for="mobile_social_apps_p_i" class="form-label"> <i data-feather="instagram"></i></label>
                    </div>
                    <div class="mb-2 mt-5   col-md-4">
                    ...
                    <div class="mb-2 mt-5   col-md-6">
                        ...
                        <input type="radio" name="bizz_international_options" class="ml-2" value="0" required>
                        <label for="bizz_international_options" class="form-label">Optie Bizz International met Bizz
                            Mobile
                    ...
                    <div class="mb-2 mt-5   col-md-3">
                        ...
                        <input type="radio" name="bizz_international_options" class="ml-2" value="1" required>
                        <label for="bizz_international_options" class="form-label"> Mobile Coverage Extender
                        </label>
                    </div>
                    <div class="mb-2 mt-5   col-md-3">

                        <input type="radio" name="bizz_international_options" class="ml-2" value="2" required>
                    ...
                    <div class="mb-2 mt-3 col-md-6">
                        <label for="second_number_text" class="form-label">2nr<span class="text-danger">*</span></label>
                    ...
                    <div class="mb-2 mt-5   col-md-3">
                        ...
                        <input type="radio" name="is_connection_present_in_house" class="ml-2" value="0" required>
                    ...
                    <div class="mb-2 mt-5   col-md-3">
                        ...
                        <input type="radio" name="is_connection_present_in_house" class="ml-2" value="1" required>
                    ...
                    <div class="mb-2 mt-5   col-md-4">
                        ...
                        <label for="mobile_modem_config_type" class="form-label"> Pack Take Away b-box3 + hd-decoder
                    ...
                    <div class="mb-2 mt-5   col-md-4">
                        ...
                        <label for="mobile_modem_config_type" class="form-label"> Huur Hd-decoder - zonder harde schijf
                    ...
                    <div class="mb-2 mt-5   col-md-6">
                        ...
                        <label for="kit_to_install_k" class="form-label">Kit om te installeren: €59 (activeringskosten
                            inbegrepen)
                        </label>
                    </div>
                    ...
                    <div class="mb-2 mt-5   col-md-6">
                        ...
                        <label for="free_resources" class="form-label">gratis in de Packs Flex, Epic Combo en tweede
                    ...
                    <div class="mb-2 mt-3 col-md-6">
                        <label for="desired_employment_date" class="form-label mt-2">Gewenste datum indiensttreding<span
                                class="text-danger">*</span></label>
                        <input class="form-control @error('desired_employment_date') is-invalid @enderror mb-4 mb-md-0"
                            data-inputmask="'alias': 'datetime'" data-inputmask-inputformat="dd/mm/yyyy"
                    ...
                    <div class="mb-2 mt-4   col-md-6">
                        ...
                        <input type="refer_number_k" class="form-control @error('refer_number_k') is-invalid @enderror"
                            id="refer_number_k" autocomplete="off" placeholder="Referentienummer (optioneel)"
                            name="refer_number_k" value="{{ old('refer_number_k') }}" required>
                    ...
                    <div class="mb-2 mt-5   col-md-12">
                        ...
                        <label for="consent_m" class="form-label"> Ik geef Proximus van publiek recht niet de toelating
                            mijn gegevens
