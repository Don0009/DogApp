                ...
                <form action="{{ route('proximus_connection_request_du.store') }}" method="post">@csrf
                    <div class="row">
                        ...
                        <div class="mb-2 mt-5   col-md-3">
                            ...
                            <input type="radio" name="mobilus_full_control_options" class="ml-2" value="1"
                                required>
                            <label for="mobilus_full_control_options" class="form-label">Large</label>
                        </div>
                        <div class="mb-2 mt-5   col-md-3">

                            <input type="radio" name="mobilus_full_control_options" class="ml-2" value="2"
                                required>
                            <label for="mobilus_full_control_options" class="form-label">Medium</label>
                        </div>
                        <div class="mb-2 mt-5   col-md-3">

                            <input type="radio" name="mobilus_full_control_options" class="ml-2" value="3"
                                required>
                        ...
                        <div class="mb-2 mt-5   col-md-4">
                            ...
                            <label for="mobile_business_types" class="form-label">Business Mobile Unlimited
                                Light</label>
                        </div>
                        <div class="mb-2 mt-5   col-md-4">
