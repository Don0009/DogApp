                    ...
                    <table id="dataTableExample" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form class="d-inline-block" action="{{ route('mobile_application_form.destroy', $mobile->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                    ...
                                    <a href="{{ route('mobile_application_form.show', $mobile->id) }}" class="btn btn-success btn-icon-text">
