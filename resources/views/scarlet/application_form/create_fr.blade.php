    ...
    <div class="container">
        <div class="card">
            <div class="card-body">
                ...
                <p style="text-align:left"><b>A. Vos coordonnées client </b>(veuillez compléter ce formulaire en majuscules
                    svp)</p>
                <form class="forms-sample" method="POST" action="{{ route('application_form.store') }}">
                    @csrf()
                    <div class="mt-2">
                        <label for="user_id" class="form-label"><span class="text-danger"></span></label>
                        <input type="hidden" class="form-control @error('user_id') is-invalid @enderror" id="f_name"
                            autocomplete="off" placeholder="User ID" name="user_id" value="{{ old('user_id') }}" required>
                        @error('user_id')
                    ...
                    <div class="mt-2">
                        <label for="id_card_number" class="form-label">N° de carte d’identité:<span
                                class="text-danger">*</span></label>
                        <input type="text" class="form-control @error('Id_card_number') is-invalid @enderror" id="name"
                            autocomplete="off" placeholder="Nom" name="id_card_number" value="{{ old('id_card_number') }}"
                            required>
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control @error('adress') is-invalid @enderror" id="name"
                                    autocomplete="off" placeholder="Adress" name="adress" value="{{ old('adress') }}"
                                    required>
                                @error('adress')
                                    <span class="invalid-feedback mb-2" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="col-3">
                                ...
                                <input type="text" class="form-control @error('box') is-invalid @enderror" id="name"
                                    autocomplete="off" placeholder="N°" name="box" value="{{ old('box') }}" required>
                                @error('box')
                                    <span class="invalid-feedback mb-2" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control @error('postal_code') is-invalid @enderror"
                                    id="postal_code" autocomplete="off" placeholder="Postal Code" name="postal_code"
                            ...
                            <div class="col-6">
                                <label for="commune" class="form-label">Commune<span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control @error('commune') is-invalid @enderror" id="commune"
                                    autocomplete="off" placeholder="commune" name="commune" value="{{ old('commune') }}"
                                    required>
                                @error('commune')
                                    <span class="invalid-feedback mb-2" role="alert">
                                        <strong>{{ $message }}</strong>
                    ...
                    <div class="mt-2">
                        <div class="row">
                            <div class="col-6">
                                <label for="society" class="form-label">Societe:<span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control @error('society') is-invalid @enderror"
                                    id="commune" autocomplete="off" placeholder="Societe" name="society"
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control @error('TVA') is-invalid @enderror" id="vat"
                                    autocomplete="off" placeholder="TVA" name="vat" value="{{ old('vat') }}" required>
                                @error('vat')
                                    <span class="invalid-feedback mb-2" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="mt-2">
                        <div class="row">
                            <div class="col-6">
                                ...
                                <label for="internet_connection" class="form-label">Je possède déjà une connexion
                                    internet</label>
                            </div>
                            <div class="col-2">
                    ...
                    <div class="mt-4">
                        <p><b>Attention!</b> Scarlet Trio n’est pas approprié pour raccorder des lignes téléphoniques du
                            type ISDN, des centrales d’alarmes, des modems
                            dial-up, des terminaux de paiement, des centrales téléphoniques et des fax, alors uniquement
                            l’option ‘nouvelle paire de cuivre’ est possible
                    ...
                    <div class="mt-2">
                        <p class="text-justify "><input type="radio" name="your_subscription" class="mr-2"
                                value="1">Oui, je prends <b>Scarlet Loco</b> (Internet³) avec ou sans ligne téléphonique
                            existante à € 32 TVA incl. par mois. (Frais uniques
                            de 50€ pour l’activation de la ligne)</p>
                    </div>
                    <div class="mt-2">
                        <p class="text-justify"><input type="radio" name="your_subscription" class="mr-2"
                                value="2">Oui, je prends <b>Scarlet Internet&Téléphonie²</b> avec ou sans ligne téléphonique
                            existante à € 39 TVA incl. par mois.(Frais
                            unique de 50€ pour l’activation de la ligne)</p>
                    </div>
                    <div class="mt-2">
                        <p class="text-justify"><input type="radio" name="your_subscription" class="mr-2"
                                value="3">Oui, je prends <b>Scarlet Trio</b> (Internet + Téléphony + TVD²³) avec ou sans
                            ligne téléphonique existante à € 40 TVA incl.
                            par mois</p>
                    </div>
                    ...
                    <div class="mt-2">
                        <div class="row">
                            <div class="col-6">
                                ...
                                <label for="telephony_day_1" class="form-label">Téléphonie nationale gratuite
                                    24h/24h</label>
                            </div>
                            <div class="col-6">
                    ...
                    <div class="mt-2">
                        <div class="row">
                            <div class="col-6">
                                ...
                                <label for="telephony_hour_1" class="form-label">Téléphonie nationale mobile gratuite
                                    (heures creuses)</label>
                            </div>
                            <div class="col-6">
                    ...
                    <div class="mt-2">
                        <div class="row">
                            <div class="col-6">
                                ...
                                <label for="mobile_tele_day_1" class="form-label">Téléphonie nationale mobile gratuite
                                    (24h/24h) </label>
                            </div>
                            <div class="col-6">
                    ...
                    <div class="mt-2">
                        <div class="row">
                            <div class="col-6">
                                ...
                                <label for="fixe_telephony_hour_1" class="form-label">Téléphonie internationale fixe
                                    gratuite (heures creuses²)</label>
                            </div>
                            <div class="col-6">
                    ...
                    <div class="mt-2">
                        <label for="total_one_time_costs_vat" class="form-label">Total des coûts uniques TVA incl:<span
                                class="text-danger">*</span></label>
                        <div class="input-group mb-3">
                            <span class="input-group-text" id="basic-addon1">€</span>
                            <input type="number"
                    ...
                    <div class="mt-2">
                        ...
                        <label for="type_number" class="form-label">Je souhaite garder mon numéro de téléphone
                            actuel</label>
                    </div>
                    <div class="mt-1">
                        <p class="ml-5">Veuillez compléter le document ci-joint, « Autorisation pour la
                            portabilité du numéro fixe »</p>
                    </div>
                    <div class="mt-2">
                        <div class="row">
                            <div class="col-3">
                    ...
                    <div class="mt-2">
                        <div class="row">
                            <div class="col-6">
                                <label for="vat" class="form-label">Autres:<span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="col-6">
                                <label for="vat" class="form-label">Numéro de client:<span
                                        class="text-danger">*</span></label>
                    ...
                    <div class="mt-2">
                        <p><input type="radio" name="type_number" class="mr-2" value="2">Je souhaite que mon
                            numéro de Téléphone ne soit pas mentionné dans les pages blanches</p>
                    </div>
                    <div class="mt-4">
                        <h4 style="text-align:center"><b>D. Installation</b></h4>
                    </div>
                    <div class="mt-2">
                        <p>Si l’adresse d’installation ne correspond pas à l’adresse de vos données personnelles, prière de
                            remplir l’adresse d’installation
                            ci-dessous</p>
                    </div>
                    <div class="mt-2">
                        <div class="row">
                            ...
                            <div class="col-3">
                                <label for="install_no" class="form-label">N°:<span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="col-3">
                                <label for="install_box" class="form-label">Boite:<span
                                        class="text-danger">*</span></label>
                    ...
                    <div class="mt-2">
                        <div class="row">
                            <div class="col-6">
                                <label for="install_postal_code" class="form-label">Code Postale<span
                                        class="text-danger">*</span></label>
                                <input type="number"
                            ...
                            <div class="col-6">
                                <label for="install_commune" class="form-label">Commune<span
                                        class="text-danger">*</span></label>
                    ...
                    <div class="mt-2">
                        ...
                        <label for="payment_method" class="form-label">Je crée un mandat pour domiciliation en
                            utilisant les données bancaires suivantes :
                        </label>
                    </div>
                    <div class="mt-2">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <label for="name_account_holder" class="form-label">Nom du titulaire du compte :<span
                                        class="text-danger">*</span></label>
                    ...
                    <p class="test-justify mt-3">Les coordonnées communiquées dans ce contexte sont enregistrées dans la
                        base de données de Scarlet Rue Carli 2, 1140 Evere.
                        Ces données sont traitées par Scarlet dans le cadre de l’administration de la clientèle, des études
                        de marché et dans l’optique de
                        l’organisation de campagnes publicitaires et d’information personnalisées relatives aux produits et
                        services de Scarlet et/ou de
                        tiers. Vous avez le droit de demander à tout moment une copie de vos données à caractère personnel
                        pour vérifier l’exactitude des
                        informations qui sont conservées et/ou pour les corriger ou les mettre à jour.
                    </p>
                    <div class="mt-2">
                        <p>Si vous accordez le droit à Scarlet d’utiliser vos coordonnées communiquées pour les raisons
                            mentionnées ci-dessus, veuillez
                            cocher cette case<input type="checkbox" name="submitted_contact" class="ml-2"
                                value="1"></p>
                    </div>
                    <div class="mt-3">
                    ...
                    <div class="mt-2">
                        <div class="row">
                            <div class="col-6">
                                <label for="made_in" class="form-label">Fait à:<span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="col-3">
                                ...
                                <input type="text" class="form-control @error('the') is-invalid @enderror" id="the"
                                    autocomplete="off" placeholder="Le" name="the" value="{{ old('the') }}" required>
                                @error('the')
                                    <span class="invalid-feedback mb-2" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-3">
                                <label for="contact_date" class="form-label">Date:<span
                                        class="text-danger">*</span></label>
                    ...
                    <div class="mt-2">
                        <div class="row">
                            <div class="col-6">
                                <label for="dealer_reference" class="form-label">Référence du dealer Scarlet:<span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="col-6">
                                <label for="agent" class="form-label">Agent:<span
                                        class="text-danger">*</span></label>
                    ...
                    <p class="text-justify">Veuillez compléter ce formulaire en majuscules, le signer et le renvoyer
                        rapidement à Scarlet. Sans celui-ci vous ne
                    ...
                    <div class="mt-2">
                        <label for="undersigned" class="form-label">Le soussigné<span
                                class="text-danger">*</span></label>
                    ...
                    <div class="mt-3">
                        <p>titulaire du numéro susmentionné, donne l’autorisation à l’opérateur récipient, Scarlet Belgium
                            sa, de procéder au transfert de ce numéro. Cette autorisation de transfert implique que le
                            soussigné résilie son contrat d’abonnement téléphonique avec son opérateur actuel</p>
                    </div>
                    <div class="mt-2">
                        <div class="row">
                            <div class="col-6">
                                <label for="main_line" class="form-label">Ligne principale:<span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control @error('main_line') is-invalid @enderror"
                                    id="main_line" autocomplete="off" maxlength="9" placeholder="Ligne principale"
                            ...
                            <div class="col-6">
                                <label for="2nd_line" class="form-label">2e ligne:<span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control @error('2nd_line') is-invalid @enderror"
                                    id="2nd_line" autocomplete="off" maxlength="9" placeholder="2e ligne" name="2nd_line"
                    ...
                    <div class="mt-2">
                        <p class="text-justify">Le signataire du présent document reconnaît qu’il assure l’entière
                            responsabilité de l’exactitude des informations y
                            contenues et s’engage à indemniser l’abonné de tout dommage quelconque subi en raison de, ou à
                            la suite de la présente
                            demande de portabilité. Le signataire indemnisera également le fournisseur de services de tout
                            préjudice résultant d’une
                            réclamation de l’abonné en relation avec l’exécution de la présente demande de portabilité. Le
                            signataire confirme qu’il est
                    ...
                    <div class="mt-2">
                        <label for="holder_no" class="form-label">No du titulaire:<span
                                class="text-danger">*</span></label>
                    ...
                    <div class="mt-2">
                        <div class="row">
                            ...
                            <div class="col-4">
                                <label for="number" class="form-label">Numéro:<span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="col-4">
                                <label for="add_box" class="form-label">Boite:<span
                                        class="text-danger">*</span></label>
                    ...
                    <div class="mt-2">
                        <div class="row">
                            <div class="col-6">
                                <label for="add_postal_code" class="form-label">Code Postale<span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="col-6">
                                <label for="add_commune" class="form-label">Commune<span
                                        class="text-danger">*</span></label>
                    ...
                    <div class="mt-2">
                        <div class="row">
                            <div class="col-4">
                                <label for="vat_number" class="form-label">Numéro de TVA (si d’application):<span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="col-4">
                                <label for="current_operator" class="form-label">Opérateur actuel:<span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="col-4">
                                <label for="cus_number" class="form-label">Numéro de client chez l’opérateur
                    ...
                    <div class="mt-4">
                        <p>(Pour connaître votre numéro de client Belgacom, formez le 078 15 05 65. Si vous n’appelez pas de
                            chez vous,
                    ...
                    <div class="mt-2">
                        <div class="row">
                            <div class="col-4">
                                <label for="contact_date_1" class="form-label">Date:<span
                                        class="text-danger">*</span></label>
