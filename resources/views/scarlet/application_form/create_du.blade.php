    ...
    <div class="card">
        <div class="card-body">
            ...
            <form class="forms-sample" method="POST" action="{{ route('application_form.store') }}">
                ...
                <div class="mt-2">
                    <p><b>Opgelet!</b> Indien uw telefoonlijn van het type ISDN is, uitgerust met PABX telefooncentrale of verbonden is met alarmcentrales,
                        dial-up modems, betaalterminals, telefooncentrales of faxtoestellen dan is Scarlet Trio niet geschikt. In dat geval is enkel via de optie ‘vrij
                        koperpaar mogelijk!.
                ...
                <div class="mt-2">
                    <label for="total_one_time_costs_vat" class="form-label">Totaal eenmalige kosten BTW incl.<span class="text-danger">*</span></label>
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1">€</span>
                ...
                <div class="mt-1">
                    <p class="ml-5">Gelieve het bijgevoegde document “Toelating voor Nummeroverdracht Vaste Telefonie” in te vullen. </p>
                </div>
                <div class="mt-2">
                    <div class="row">
                        <div class="col-3">
                ...
                <div class="mt-2">
                    <div class="row">
                        <div class="col-6">
                            <label for="vat" class="form-label">Andere:<span class="text-danger">*</span></label>
                        ...
                        <div class="col-6">
                            <label for="vat" class="form-label">Klantnummer:<span class="text-danger">*</span></label>
                ...
                <div class="mt-2">
                    <p>Indien het installatieadres niet hetzelfde is als het adres dat u bij uw persoonlijke gegevens invulde, gelieve dan hier het juiste
                ...
                <div class="mt-2">
                    <div class="row">
                        ...
                        <div class="col-3">
                            <label for="install_no" class="form-label">Nr:<span class="text-danger">*</span></label>
                        ...
                        <div class="col-3">
                            <label for="install_box" class="form-label">Bus:<span class="text-danger">*</span></label>
                ...
                <div class="mt-2">
                    <div class="row">
                        <div class="col-6">
                            <label for="install_postal_code" class="form-label">Postcode<span class="text-danger">*</span></label>
                        ...
                        <div class="col-6">
                            <label for="install_commune" class="form-label">Gemeente<span class="text-danger">*</span></label>
                ...
                <p class="test-justify">Scarlet, Carlistraat 2, 1140 Evere, wenst de persoonsgegevens die u hierbij verstrekt op te nemen in haar bestanden. Zij wenst
