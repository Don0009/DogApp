        ...
        <form class="forms-sample" method="POST" action="{{ route('subscription_request.store') }}">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-6">
                            <label for="id_card_number" class="form-label">Nummer identiteitskaart<span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('id_card_number') is-invalid @enderror" id="name"
                                autocomplete="off" placeholder="Nummer identiteitskaart" name="id_card_number"
                    ...
                    <div class="row mt-2">
                        <div class="col-6">
                            <label for="nationality" class="form-label">Nationaliteit<span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('nationality') is-invalid @enderror"
                                id="nationality" autocomplete="off" placeholder="Nationaliteit" name="nationality"
                        ...
                        <div class="col-6">
                            <label for="company_name" class="form-label">Naam van het bedrijf / Master Account en
                                juridische vorm<span class="text-danger">*</span></label>
                        ...
                        <div class="col-5">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control @error('rpm_no') is-invalid @enderror" id="rpm_no"
                                    autocomplete="off" placeholder="BTW/RPR nr" name="rpm_no" value="{{ old('rpm_no') }}"
                                    required>
                                @error('rpm_no')
                                    <span class="invalid-feedback mb-2" role="alert">
                                        <strong>{{ $message }}</strong>
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-4">
                            ...
                            <input type="text" class="form-control @error('box') is-invalid @enderror" id="box"
                                autocomplete="off" placeholder="Nr/Bus" name="box" value="{{ old('box') }}" required>
                            @error('box')
                                <span class="invalid-feedback mb-2" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-4">
                            <label for="locality" class="form-label">Gemeente<span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('locality') is-invalid @enderror" id="locality"
                                autocomplete="off" placeholder="Gemeente" name="locality" value="{{ old('locality') }}"
                                required>
                            @error('locality')
                                <span class="invalid-feedback mb-2" role="alert">
                                    <strong>{{ $message }}</strong>
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-3">
                            ...
                            <input type="text" class="form-control @error('fax') is-invalid @enderror" id="locality"
                                autocomplete="off" placeholder="FAX" name="fax" value="{{ old('fax') }}" required>
                            @error('fax')
                                <span class="invalid-feedback mb-2" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-3">
                            <label for="mail" class="form-label">E-mail adres<span
                                    class="text-danger">*</span></label>
                    ...
                    <div class="row mt-2">
                        <div class="col-9">
                            <p>Ik wens dat mijn adresgegevens vermeld worden in een telefoongids en/of in een
                                inlichtingendienst:</p>
                        </div>
                        <div class="col-2">
                            ...
                            <label for="contact_details" class="form-label">nee</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-9">
                    ...
                    <p class="mt-0">Indien u geen commerciële oproepen meer wenst te ontvangen, kan u zich
                        inschrijven op volgende web pagina: www.bel-me-niet-meer.be</p>
                    <div class="row">
                        <div class="col-11">
                            <p>Ik aanvaard dat mijn gegevens ook gebruikt worden voor direct marketing doeleinden door de
                                rechtstreekse partners van Telenet Group bvba:</p>
                        </div>
                        <div class="col-1">
                    ...
                    <div class="row mt-2">
                        <div class="col-6">
                            <label for="bank_account" class="form-label">Bankrekeningnummer IBAN<span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('bank_account') is-invalid @enderror"
                                id="bank_account" autocomplete="off" placeholder="Bankrekeningnummer IBAN"
                        ...
                        <div class="col-6">
                            <label for="billing_address" class="form-label">Facturatieadres (indien verschillend):<span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('billing_address') is-invalid @enderror"
                                id="postal_code" autocomplete="off" placeholder="Facturatieadres (indien verschillend)"
                    ...
                    <div class="row mt-2">
                        <div class="col-6">
                            <label for="street1" class="form-label">Straat<span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('street1') is-invalid @enderror" id="street1"
                                autocomplete="off" placeholder="Straat" name="street1" value="{{ old('street1') }}"
                                required>
                            @error('street1')
                                <span class="invalid-feedback mb-2" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control @error('box1') is-invalid @enderror" id="box1"
                                autocomplete="off" placeholder="Nr/Bus" name="box1" value="{{ old('box1') }}" required>
                            @error('box1')
                                <span class="invalid-feedback mb-2" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="row mt-2">
                        <div class="col-6">
                            <label for="locality1" class="form-label">Gemeente<span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('locality1') is-invalid @enderror"
                                id="locality1" autocomplete="off" placeholder="Gemeente" name="locality1"
                    ...
                    <p>Indien U, in uw hoedanigheid van consument, deze overeenkomst heeft afgesloten buiten de onderneming
                        van de verkoper, te weten op een salon, beurs of tentoonstelling, is de volgende clausule van
                        toepassing:</p>
                    <div class="mt-2">
                        <label for="contract" class="form-label">Deze overeenkomst werd afgesloten naar aanleiding
                            van<span class="text-danger">*</span></label>
                        <input type="text" class="form-control @error('contract') is-invalid @enderror" id="contract"
                            autocomplete="off" placeholder="Deze overeenkomst werd afgesloten naar aanleiding van"
                            name="contract" value="{{ old('contract') }}" required>
                        @error('contract')
                            <span class="invalid-feedback mb-2" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="mt-2">
                        <label for="formula" class="form-label">Tariefformule<span
                                class="text-danger">*</span></label>
                        <input type="text" class="form-control @error('formula') is-invalid @enderror" id="formula"
                            autocomplete="off" placeholder="Tariefformule" name="formula" value="{{ old('formula') }}"
                            required>
                        @error('formula')
                            <span class="invalid-feedback mb-2" role="alert">
                                <strong>{{ $message }}</strong>
                    ...
                    <div class="row mt-2">
                        <div class="col-6">
                            <label for="phone_num" class="form-label">Telefoonnummer<span
                                    class="text-danger">*</span></label>
                            <input type="phone" class="form-control @error('phone_num') is-invalid @enderror"
                                id="phone_num" autocomplete="off" placeholder="Telefoonnummer" name="phone_num"
                        ...
                        <div class="col-6">
                            <label for="number_sim" class="form-label">SIM-kaart nr<span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('number_sim') is-invalid @enderror"
                                id="number_sim" autocomplete="off" placeholder="SIM-kaart nr" name="number_sim"
                    ...
                    <div class="row mt-2">
                        <div class="col-3">
                            <label for="sim_card" class="form-label">Aantal SIMkaarten<span
                                    class="text-danger">*</span></label>
                    ...
                    <div class="row mt-2">
                        <div class="col-4">
                            <label for="date_renewal" class="form-label">Uiterste datum verzet verlenging:<span
                                    class="text-danger">*</span></label>
                        ...
                        <div class="col-8">
                            <label for="distributer" class="form-label">Verdeler<span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('distributer') is-invalid @enderror"
                                id="distributer" autocomplete="off" placeholder="Verdeler" name="distributer"
                    ...
                    <div class="row mt-2">
                        <div class="col-6">
                            <label for="client_number" class="form-label">Klantnummer:<span
                                    class="text-danger">*</span></label>
                        ...
                        <div class="col-6">
                            <label for="distributor_number" class="form-label">Nummer verdeler:<span
                                    class="text-danger">*</span></label>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-2">
                        <label for="easier_company_name" class="form-label">Firmanaam en juridische vorm<span
                                class="text-danger">*</span></label>
                        <input type="text" class="form-control @error('easier_company_name') is-invalid @enderror"
                            id="easier_company_name" autocomplete="off" placeholder="Firmanaam en juridische vorm"
                            name="easier_company_name" value="{{ old('easier_company_name') }}" required>
                    ...
                    <div class="row mt-2">
                        <div class="col-6">
                            <label for="easier_name" class="form-label">Naam<span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('easier_name') is-invalid @enderror"
                                id="easier_name" autocomplete="off" placeholder="Naam" name="easier_name"
                    ...
                    <div class="row mt-2">
                        <div class="col-4">
                            <label for="easier_street" class="form-label">Straat<span
                                    class="text-danger">*</span></label>
                        ...
                        <div class="col-4">
                            <label for="easier_box" class="form-label">Nr/Bus<span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('easier_box') is-invalid @enderror"
                                id="easier_box" autocomplete="off" placeholder="Nr/Bus" name="easier_box"
                        ...
                        <div class="col-4">
                            <label for="easier_postal_code" class="form-label">Postcode<span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('easier_postal_code') is-invalid @enderror"
                                id="easier_postal_code" autocomplete="off" placeholder="Postcode" name="easier_postal_code"
                                value="{{ old('easier_postal_code') }}" required>
                    ...
                    <div class="row mt-2">
                        <div class="col-6">
                            <label for="easier_locality" class="form-label">Gemeente<span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('easier_locality') is-invalid @enderror"
                                id="easier_locality" autocomplete="off" placeholder="Gemeente" name="easier_locality"
                        ...
                        <div class="col-6">
                            <label for="easier_cus_number" class="form-label">Telenet Group bvba klantnummer<span
                                    class="text-danger">*</span></label>
                    ...
                    <p class="mt-4">geef hierbij uitdrukkelijk toestemming aan Telenet Group bvba -
                        Neerveldstraat 105 - 1200 Brussel, om alle Telenet Group bvba facturen met
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-2">
                            <label for="due_date" class="form-label">Vervaldatum<span
                                    class="text-danger">*</span></label>
                    ...
                    <p class="mt-3">Hebt u een nieuw kaartnummer ? Laat ons dan zo snel mogelijk iets weten. Het
                        adres vindt u bovenaan.</p>
                    <p class="mt-2">Bij weigering tot betaling door mijn kredietkaartfirma, blijf ikzelf volledig
                        verantwoordelijk voor de betaling van mijn facturen.</p>
                    <div class="row mt-3">
                        <div class="col-4">
                            <label for="agre_date" class="form-label">Datum<span
                                    class="text-danger">*</span></label>
                        ...
                        <div class="col-4">
                            <label for="agre_locality" class="form-label">Plaats:<span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('agre_locality') is-invalid @enderror"
                                id="locality1" autocomplete="off" placeholder="Plaats" name="agre_locality"
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="mt-5">Indien u uw facturen per domiciliëring wenst te betalen, gelieve dan dit
                        formulier in te vullen en naar ons terug te sturen.</p>
                    <p>We benadrukken dat u uw facturen per overschrijving dient te betalen zolang u een
                        overschrijvingsformulier ontvangt.</p>
                    <h5 class="mt-4">Mandaat referte (voorbehouden voor Telenet Group)</h5>
                    <div class="mt-3">
                        <label for="mandate_number" class="form-label">Mandaatnummer<span
                                class="text-danger">*</span></label>
                        <input type="text" class="form-control @error('mandate_number') is-invalid @enderror"
                            id="mandate_number" autocomplete="off" placeholder="Mandaatnummer" name="mandate_number"
                    ...
                    <div class="row mt-3">
                        <div class="col-4">
                            <label for="debtor_name" class="form-label">Naam van de schuldenaar<span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('debtor_name') is-invalid @enderror"
                                id="debtor_name" autocomplete="off" placeholder="Naam van de schuldenaar" name="debtor_name"
                        ...
                        <div class="col-4">
                            <label for="signed_f_name" class="form-label">Voornaam<span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('signed_f_name') is-invalid @enderror"
                                id="signed_f_name" autocomplete="off" placeholder="Voornaam" name="signed_f_name"
                        ...
                        <div class="col-4">
                            <label for="signed_street" class="form-label">Straat<span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('signed_street') is-invalid @enderror"
                                id="signed_street" autocomplete="off" placeholder="Straat" name="signed_street"
                    ...
                    <div class="row mt-3">
                        <div class="col-4">
                            <label for="signed_box" class="form-label">Nr/Bus<span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('signed_box') is-invalid @enderror"
                                id="locality1" autocomplete="off" placeholder="Nr/Bus" name="signed_box"
                        ...
                        <div class="col-4">
                            <label for="signed_locality" class="form-label">Gemeente<span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('signed_locality') is-invalid @enderror"
                                id="signed_locality" autocomplete="off" placeholder="Gemeente" name="signed_locality"
                        ...
                        <div class="col-4">
                            <label for="signed_postal_code" class="form-label">Postcode<span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('signed_postal_code') is-invalid @enderror"
                                id="signed_postal_code" autocomplete="off" placeholder="Postcode" name="signed_postal_code"
                                value="{{ old('signed_postal_code') }}" required>
                    ...
                    <div class="row mt-3">
                        <div class="col-4">
                            <label for="signed_country" class="form-label">Land<span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('signed_country') is-invalid @enderror"
                                id="signed_country" autocomplete="off" placeholder="Land" name="signed_country"
                        ...
                        <div class="col-4">
                            <label for="signed_iban" class="form-label">IBAN-rekeningnummer<span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('signed_iban') is-invalid @enderror"
                                id="signed_iban" autocomplete="off" placeholder="IBAN-rekeningnummer" name="signed_iban"
                        ...
                        <div class="col-4">
                            <label for="signed_bic" class="form-label">BIC-code<span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('signed_bic') is-invalid @enderror"
                                id="signed_bic" autocomplete="off" placeholder="BIC-code" name="signed_bic"
                    ...
                    <div class="row mt-3">
                        <div class="col-8">
                            <p>Nummer van het onderliggende contract (uw klantnummer) tussen Telenet Group en de
                                schuldenaar:</p>
                        </div>
                        <div class="col-4">
                    ...
                    <div class="row mt-2">
                        <div class="col-4">
                            <label for="signed_date" class="form-label">Datum:<span
                                    class="text-danger">*</span></label>
