            ...
            <div class="col-4">
                <div class="mb-2">
                    ...
                    <input type="number" class="form-control @error('present_to_luminus') is-invalid @enderror"
                        id="present_to_luminus" autocomplete="off" placeholder="RESERVE A LUMINUS" name="present_to_luminus"
                    ...
                    <div class="col-6">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="name" class="form-control @error('identity_card') is-invalid @enderror"
                                id="identity_card" autocomplete="off" placeholder="carte d'identitie" name="identity_card"
                    ...
                    <div class="col-6">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="date" class="form-control @error('naissance') is-invalid @enderror"
                                id="naissance" autocomplete="off" placeholder="Date de naissance" name="naissance"
                ...
                <div class="col-11">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="name" class="form-control @error('bus') is-invalid @enderror"
                            id="bus" autocomplete="off" placeholder="Boltie" name="bus"
      ...
      <div class="row">
          <div class="col-6">
            <div class="card">
              ...
              <div class="">(Toutes les information figurent dans les conditions particulieres applicables au tarif que vous avez choisi. Si vous ne cochez rein ou si vous</div>
              <div class="">completez erronement votre avis de domiciliation, vous devrez automatiquement payer par viement.)</div>
              <div class="row">
                  <div class="col-12">
                      <div class="mb-2 container">
              ...
              <div class="row">
                  <div class="col-12">
                      <div class="mb-2 container">
                          ...
                          <label for="digitale" class="mb-3 form-label mt-2"><b>Domiciliation.</b> pendant la duree de mon contract, mes factures seront debitees automatiquement de mon compte bancaire suivant la frequence mentionnee ci-contre. La duree du mandat de domicilation se limite a al duree du contrat,y compris le delai necessaire pour le traitement et le reglement de mon decompte. <b>Le mandat de domicilation ci-dessous est d'application</b>
              ...
              <div class="row">
                  <div class="col-12">
                      <div class="mb-2 container">
                          ...
                          <label for="my_advance_invoices" class="mb-3 form-label mt-2">pour mes factures d'acompte et mes decomptes<span
                                  class="text-danger">*</span></label>
              ...
              <div class="row">
                  <div class="col-12">
                      <div class="mb-2 container">
                          ...
                          <label for="my_advance_invoices" class="mb-3 form-label mt-2">uniquement pour mes factures d'acompte et pas pour mes de'comptes<span
                                  class="text-danger">*</span></label>
                          @error('my_advance_invoices')
                              <span class="invalid-feedback mb-2" role="alert">
                                  <strong>{{ $message }}</strong>
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="mb-2 ">
                ...
                <label for="bepaaid" class="mb-3 form-label mt-2">establi en accord avec Luminus<span
                        class="text-danger">*</span></label>
                @error('bepaaid')
                    <span class="invalid-feedback mb-2" role="alert">
                        <strong>{{ $message }}</strong>
    ...
    <div class="row">
        <div class="col-12">
            <div class="mb-2 ">
                ...
                <label for="gebaseerd" class="ml-4 form-label" style="margin-top: -50px">base sot cequeje paie a ujeurd'h w chef mon furnisseur actuel <span
                        class="text-danger">*</span></label>
                @error('gebaseerd')
                    <span class="invalid-feedback mb-2" role="alert">
                        <strong>{{ $message }}</strong>
...
<div class="row">
    <div class="card">
        <div class="card-body ">
    <div class="col-12">
        <div class="">Je reconnais expressement avoir pris connaissance, preablement a la signature du present contrat, des Conditions generales, y compris I'existence et les modalities d'exercise du droit de retraction et les Conditionns particulieres, et les avoir comparies et acceptees</div>
    </div>
</div>
</div>
</div>
      ...
      <div class="container-fluid">
          <div class="row grid-margin stretch-card">
            ...
            <h4><b>Signature du client</b></h4>
              <div class="col-6">
                  <div class="">Ce contract n'est pas valable sans la signature du client dans la case prevue a cet effect</div>
                  <div class="row">
                    ...
                    <div class="col-11">
                        <div class="mb-2">
                            ...
                            <input type="name" class=" mt-2 form-control @error('annual_consumption_8') is-invalid @enderror "
                                id="annual_consumption_8" autocomplete="off" placeholder="Nom" name="annual_consumption_8"
                      ...
                      <div class="col-10">
                          <div class="mb-2">
                              ...
                              <input type="date" class=" mt-2 form-control @error('annual_consumption_9') is-invalid @enderror "
                                  id="annual_consumption_9" autocomplete="off" placeholder="Date" name="annual_consumption_9"
          ...
          <div class="mb-2 ">
            ...
            <label for="digitale_1" class="mb-3 form-label mt-2"><b>Si vous ne scuhaitez pas recevoir des &mails ou SMS concernant des produits et services similaires au produit ou service vendu, veuillez cocher cette case. Pour plus d'informations, nous vous renvoyons vers notre site web — Mentions legales et politique de confidentialite. <span
                    class="text-danger">*</span></label>
            @error('digitale_1')
                <span class="invalid-feedback mb-2" role="alert">
                    <strong>{{ $message }}</strong>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="card-body">
               ...
               <div class="row">
                   <div class="col-12">
                       <div class="">Description du contract correspondant : <b>approvisionement en energie</b></div>
            ...
            <div class="col-7">
                ...
                <div class="row">
                    ...
                    <div class="">(')Vous trowerez vos numero de compte IBAN et code BIC sur vos extraits de compte: pour un compte belge</div>
                    <div class="">I'IBAN comprend 16 caracteres, le BIC 8 ou 11 caracteres.</div>
                    <div class="">Ce numero IBAN peut Egalement etre utilise pour le remboursernent de tousles montants en rotre faveur. </div>
                </div>
