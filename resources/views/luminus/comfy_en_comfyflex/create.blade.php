                    ...
                    <div class="col-4">
                        <div class="mb-2">
                            ...
                            <input type="number" class="form-control @error('present_to_luminus') is-invalid @enderror"
                                id="present_to_luminus" autocomplete="off" placeholder="VOORBEHOUBEN AAN LUMINUS"
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <input type="name"
                                                ...
                                                id="identity_card" autocomplete="off" placeholder="identiteitskaartnummer"
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <input type="date" class="form-control @error('naissance') is-invalid @enderror"
                                                id="naissance" autocomplete="off" placeholder="Geboortedatum"
                                ...
                                <div class="col-11">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input type="name" class="form-control @error('nr') is-invalid @enderror" id="nr"
                                            autocomplete="off" placeholder="Nr." name="nr" value="{{ old('nr') }}"
                                            required>
                                        @error('name')
                                            <span class="invalid-feedback mb-2" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="mb-2 container">
                                            ...
                                            <label for="want_luminus" class="mb-3 form-label mt-2">Ik wil Luminus
                                                Comfyfkex<span class="text-danger">*</span></label>
                                            @error('want_luminus')
                                                <span class="invalid-feedback mb-2" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="mb-2 container">
                                            ...
                                            <label for="want_luminus_1" class="mb-3 form-label mt-2">Ik wil Luminus
                                                Comfy<span class="text-danger">*</span></label>
                    ...
                    <div class="col-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="">(Alle intonate hierover yea u op de bittondere voonvaarden van
                                    toepasitg op het door ugekceen tarief.k u nets aatkruin of</div>
                                <div class=""> indten u uwdonorilieirgshxicht Monet invulk wit u
                                    ata0013b5d1'63 cntrsdritVing gefactureerd warden.) </div>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-2 container">
                                            <input type="radio" name="digitale" value="1" required>
                                            <label for="digitale" class="mb-3 form-label mt-2"><b>Digitale facturr.</b> Ik
                                                ontvang at mijn facturen via email<span
                                                    class="text-danger">*</span></label>
                                            @error('digitale')
                                                <span class="invalid-feedback mb-2" role="alert">
                                                    <strong>{{ $message }}</strong>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-2 container">
                                            ...
                                            <label for="digitale" class="mb-3 form-label mt-2"><b>Domicilering.</b> Tijdens
                                                de duur van mijn contract worden mijn facturen via mijn bankrekening
                                                verrekend volgens de hiernaast vermeide freguentie. De duurtijd van het
                                                dorkilieringsmandaat beperkt zkh tot de duurtijd van het contract met
                                                inbegrip van de termijn nodig voor de venwrking en vefeffening van mijn
                                                afrekening.<b>Het onderstaande daritiliefingsmandaat geldt</b>
                                                <span class="text-danger">*</span></label>
                                            @error('digitale')
                                                <span class="invalid-feedback mb-2" role="alert">
                                                    <strong>{{ $message }}</strong>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-2 container">
                                            ...
                                            <label for="digitale" class="mb-3 form-label mt-2"><b>voor mijn
                                                    voorschotfacturen en mijn afrekeningen</b><span
                                                    class="text-danger">*</span></label>
                                            @error('digitale')
                                                <span class="invalid-feedback mb-2" role="alert">
                                                    <strong>{{ $message }}</strong>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-2 container">
                                            ...
                                            <label for="my_advance_invoices" class="mb-3 form-label mt-2">alleen voor mign
                                                voorschotfattumn en St voor mijn afrekeningen <span
                                                    class="text-danger">*</span></label>
                    ...
                    <div class="col-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="row">
                                    <div class="">
                                        <b>Schatting jaarlijkse energieprijis voor electriciteit (alle taksen
                                            inbegrepen)</b>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-2">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="">Ik erken uitchukkelijk voor de ondertekening van dit
                                            contract kennis te hebben genomen van de Algemene Voorwaarden, indusief het
                                            bestaan en de modakeiten voor het uitoefenen van het herroepingsrecht, en de
                                            Bijzondere Voorwaarden en deze te hebben begrepen en aanvaard. </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row ">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-6">
                                <div class="">Dit contract is niet geldig zonder handtekening van de Want in
                                    de daarvoor hiernaast vcorziene ruimte. </div>
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                        <div class="mb-2">
                                            ...
                                            <input type="name"
                                                ...
                                                id="annual_consumption_8" autocomplete="off" placeholder="Naam"
                                            ...
                                            <div class="col-9">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="date"
                                                        ...
                                                        id="annual_consumption_9" autocomplete="off" placeholder="Datum"
                                            ...
                                            <div class="col-10">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="name"
                                                        ...
                                                        id="Plaats_2" autocomplete="off" placeholder="Plaats"
                                                        name="Plaats_2" value="{{ old('Plaats_2') }}" required>
                                                    @error('Plaats_2')
                                                        <span class="invalid-feedback mb-2" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="mb-2 ">
                                    ...
                                    <label for="digitale_1" class="mb-3 form-label mt-2"><b> Indies u niet werst dat vAj u
                                            e-mails of sms'en sturen over prodaten en thensten die gehjkaardig zijn aan het
                                            veckahte product of de verkochte diens( gelieve dit vakje aan to vinken. Voor
                                            meer informatie verwgzen wij naar ooze website privacy policy.
                                            <span class="text-danger">*</span></label>
                                    @error('digitale_1')
                                        <span class="invalid-feedback mb-2" role="alert">
                                            <strong>{{ $message }}</strong>
                    ...
                    <div class="col-5">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="mt-2">Door ondertekening van dit mandaatfamulier geeft u toestemming
                                    aan (A) Luminus NV an een opdracht te sturen near uw bank teneinde een bedrag van Live
                                    rekening te debiteren en (B) uw bank an een bedrag van uw rekening te debiteren in
                                    overeenstemming met de opdracht van Luminus NV</div>
                                <div class="mt-2">U kunt een Europese domid kering later terugbetalen. Vraag
                                    uw6gen bank near de vcawaarden. E en veacek tot terugbetating moet tinnen 8 waken na de
                                    datum van debitedng van het bedrag van uw rekening mden ingediend.</div>
                                            ...
                                            <div class="col-8">
                                                <div class="form-group">
                                                    ...
                                                    <input required type="name" class="form-control" id="plaats_3"
                                                        autocomplete="off" placeholder="plaats_3" name="plaats_3">
                                                </div>
