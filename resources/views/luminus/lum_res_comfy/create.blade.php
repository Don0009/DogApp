            ...
            <div class="col-4">
                <div class="mb-2">
                    ...
                    <input type="number" class="form-control @error('present_to_luminus') is-invalid @enderror"
                        id="present_to_luminus" autocomplete="off" placeholder="VOORBEHOUDEN AAN LUMINUS" name="present_to_luminus"
    ...
    <div class="row">
        <div class="col-6">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                    <div class="mt-3">De consument heeft het recht aan de verkoper mee to delen dat hij afziet van de aankoop, zonder betaling van een boete en zonder o ave van motief binnen 14 kalenderda•en vanaf ontvan st van de bevesti• in, van het contract. </div></div></div>
                </div>
            </div>
        </div>
        ...
        <div class="col-6">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    ...
                    <div class="col-12">
                        <div class="mb-2">
                            ...
                            <input type="name" class="form-control @error('electriciteit') is-invalid @enderror"
                                id="electriciteit" autocomplete="off" placeholder="Maandelijks voorschotbedrag electriciteit" name="electriciteit"
                    ...
                    <div class="col-4">
                        ...
                        <div class="col-12">
                            <div class="mb-2">
                                ...
                                <input type="name" class="form-control @error('voorschotbedrag') is-invalid @enderror"
                                    id="voorschotbedrag" autocomplete="off" placeholder="Jaarverbruik* gas" name="voorschotbedrag"
                                    value="{{ old('voorschotbedrag') }}" required>
                                            ...
                                            <div class="col-12">
                                                <div class="mt-4">
                                                    ...
                                                    <input type="name" class="form-control @error('annual_consumption_1') is-invalid @enderror"
                                                        id="annual_consumption_1" autocomplete="off" placeholder="Jaarverbruik* gas" name="annual_consumption_1"
                            ...
                            <div class="col-12">
                                <div class="mt-4">
                                    ...
                                    <input type="name" class="form-control @error('annual_consumption_2') is-invalid @enderror"
                                        id="annual_consumption_2" autocomplete="off" placeholder="Jaarverbruik* gas" name="annual_consumption_2"
                ...
                <div class="row">
                    <div class=""><b>lk erken uitdrukkelijk voor de ondertekening van dit contract kennis te hebben genomen van de Algemene Voorwaarden, indusief het bestaan en de modaliteiten voor het uitoefenen van het herroepingsrecht, en de Bijzondere Voorwaarden en deze te hebben begrepen en aanvaard. </b></div>
                </div>
                            ...
                            <div class="col-8">
                                <div class="form-group">
                                    ...
                                    <input required type="name" class="form-control" id="customer_n"
                                        autocomplete="off" placeholder="Klantr"
                                        name="customer_n">
                                </div>
