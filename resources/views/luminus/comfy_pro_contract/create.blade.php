                    ...
                    <div class="col-4">
                        <div class="mb-2">
                            ...
                            <input type="number" class="form-control @error('present_to_luminus') is-invalid @enderror"
                                id="present_to_luminus" autocomplete="off" placeholder="Present To Luminus"
                                    ...
                                    <div class="row">
                                        <div class="col-5">
                                            <div class="row">
                                                <div class="col-4">
                                                    <label for="mob_num"
                                                        class="form-label"><b>Vennoot-schapsvorm</b><span
                                                            class="text-danger">*</span></label>
                                                </div>
                                                <div class="col-8">
                                                    <div class="mb-2">
                                        ...
                                        <div class="col-11">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <input type="name"
                                                    ...
                                                    autocomplete="off" placeholder="Adres" name="address"
                                        ...
                                        <div class="col-10">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <input type="name"
                                                    ...
                                                    id="post_code" autocomplete="off" placeholder="Postcode"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-10">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <input type="mail"
                                                    class="form-control @error('e_mail') is-invalid @enderror" id="e_mail"
                                                    autocomplete="off" placeholder="E-mail" name="e_mail"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-10">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <input type="name"
                                                    class="form-control @error('tel_nr') is-invalid @enderror" id="tel_nr"
                                                    autocomplete="off" placeholder="Tel.nr" name="tel_nr"
                                        ...
                                        <div class="col-10">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <input type="name"
                                                    ...
                                                    autocomplete="off" placeholder="Faxnr." name="faxnr"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-10">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <input type="name"
                                                    class="form-control @error('gsm_nr') is-invalid @enderror" id="gsm_nr"
                                                    autocomplete="off" placeholder="Gsm-nr" name="gsm_nr"
            ...
            <div class="container-fluid">
                <div class="row grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <h4>Aansluitingsadres (in te vullen indien andres dan identificatie- en factureringsadres)
                                </h4>
                                <div class="col-5">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-10">
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <input type="name"
                                                            class="form-control @error('nr_1') is-invalid @enderror"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-10">
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <input type="name"
                                                            class="form-control @error('deep') is-invalid @enderror"
                    ...
                    <div class="col-6 ">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="mt-3">De ondergetekende erkent uitdrukkelijk voor de
                                            ondertekening van dit contract kennis te hebben genomen van de Algemene
                                            Voor-waarden evenals van de Bijzondere voorwaarden (in bijalage), en ze te
                                            hebben begrepen en aar=nvard. De ondergetekende machtigt Luminus in zijn naam
                                            rekening alle handeling te stellen met oog op leverancierswissel, voor het
                                            doorvoeren van de netaansulting en voor het opvragen vaan alle (verbruiks)
                                            gegevens, inclusief, bij de netbeheerder</div>
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-body">
                                        <div class="mt-3">Indien wij u niet binnen de 20 werkdagen schriftelijk
                                            te kennen geven dat u op basis van objectieve gegevens niet kredietwaardig bent,
                                            wordt de leveringsovereenkomst definitief. </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-6">
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-2">
                                            ...
                                            <input type="name"
                                                ...
                                                placeholder="Maandelijks voorschotbedrag elektriciteit"
                                    ...
                                    <div class="">*Verbruiksgegevens volgens de meest recente afrekening.
                                    </div>
                                    <div class="">Indien het verbruik voor het aansluitadres afwjkt,
                                        contacteer ons.</div>
                                </div>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="name"
                                                        ...
                                                        placeholder="Jaarverbruik* gas" name="annual_consumption"
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="">Dit contract is niet geldig zonder handtekening van de klant in
                                    de daarvoor hieronder vooaiene ruimte. </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="">Ik verbind me ertoe elke wijziging in dat verband aan lumi nos
                                    te melden.</div>
                                <div class="">Ik vedelaar dat alle leveringspunten die vermeld staan in deze
                                    overeenkomst uitsluitend voorbehouden zijn voor beroepsgebruik</div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-2 container">
                                    ...
                                    <label for="emails_or_text_messages" class="mb-3 form-label mt-2">Indien u niet wenst
                                        dat wij u e-mails of sms'en sturen over producten en diensten die gelijkaardig zijn
                                        aan het gekochte product of dienst, gelieve dit vakje aan tevinken. Voor meer
                                        informatie verwijzen wij naar onze website privacy pokcy. <span
                                            class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="row">
                                    <div class="col-4">
                                        <label for="klantenrelaties" class="form-label"><b>Voor Luminus NV Henri
                                                Boenen, Directeur Klantenrelaties </b><span
                                                class="text-danger">*</span></label>
                                    </div>
                                    {{-- <div class="col-8">
                                <div class="mb-2">
                            ...
                            <div class="col-6">
                                <div class="row">
                                    <div class="col-4">
                                        <label for="akkoord" class="form-label"><b>Handtekening van de geldige
                                                vertegemodiger van de klant, voor akkoord </b><span
                                                class="text-danger">*</span></label>
                                    </div>
                                    {{-- <div class="col-8">
                                <div class="mb-2">
                    ...
                    <div class="col-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mt-5">Door ondertekening van dit mandaatformulier geeft u
                                            toestemming aan (A) Luminus NV om een opdracht te sturen naar uw bank teneinde
                                            een bedrag van uw rekening te debiteren en (B) uw bank om een bedrag van uw
                                            rekening te debiteren in overeenstemming met de opdracht van Luminus NV.</div>
                                        <div class="mt-2">U kunt een Europese domiciliering laten terugbetalen.
                                            Vraag uw eigen bank naar de voonvaarden. Een verzoek tot terugbetaling moet
                                            binnen 8 weken na de datum van debitering van het bedrag van uw rekening worden
                                            ingediend</div>
                                    </div>
                                </div>
                            </div>
