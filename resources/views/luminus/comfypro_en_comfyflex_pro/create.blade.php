                    ...
                    <div class="card">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="row">
                                    <div class="col-2">
                                        <label for="post_code" class="form-label"><b>Postcode</b><span
                                                class="text-danger">*</span></label>
                                    </div>
                                    <div class="col-10">
                            ...
                            <div class="col-7">
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="row">
                                            <div class="col-2">
                                                <label for="deep" class="form-label"><b>Verdiep</b><span
                                                        class="text-danger">*</span></label>
                                            </div>
                                            <div class="col-10">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="mb-2 container">
                                            ...
                                            <label for="want_luminus" class="mb-3 form-label mt-2"><b>Ik wil Luminus Comfy
                                                    Pro</b><span class="text-danger">*</span></label>
                                            @error('want_luminus')
                                                <span class="invalid-feedback mb-2" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-6">
                                        <div class="mb-2 container">
                                            ...
                                            <label for="want_luminus" class="mb-3 form-label mt-2"><b>Ik wil Luminus
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="mb-2 container">
                                            ...
                                            <label for="want_luminus_1" class="mb-3 form-label mt-2"><b>Ik wil Luminus
                ...
                <div class="row">
                    ...
                    <div class="col-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="">Beschniving van onderliggend contract: <b>levering van
                                            energie</b></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-7">
                        ...
                        <div class="row">
                            ...
                            <div class="col-11">
                                <div class="form-group">
                                    ...
                                    <input required type="name" class="form-control" id="name_1" autocomplete="off"
                        ...
                        <div class="row">
                            ...
                            <div class="col-11">
                                <div class="form-group">
                                    ...
                                    <input required type="name" class="form-control" id="adres" autocomplete="off"
                                        placeholder="Adres" name="adres">
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-11">
                                        <div class="form-group">
                                            ...
                                            <input required type="name" class="form-control" id="stad" autocomplete="off"
                                                placeholder="Stad" name="stad">
                                        </div>
                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-10">
                                        <div class="form-group">
                                            ...
                                            <input required type="name" class="form-control" id="land" autocomplete="off"
                                                placeholder="Land" name="land">
                                        </div>
                            ...
                            <div class="col-8">
                                <div class="">verzoekt de firma Luminus NV, Koning Albert || laan 7, 1210
                                    Brussel, Belgie, met identificatienummer Be50ZZZ0471811661 om,</div>
                                <div class="">vanaf heden en tot uitdrukkelijke herroeping van deze opdracht,
                                    alle facturen te incasseren van het rekeningnummer</div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <div class="form-group">
                                    ...
                                    <input required type="number" class="form-control" id="code" autocomplete="off"
                                        placeholder="Uw bank BIC code" name="code">
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="">KuntuN IBAN rekeningnummer en BIC code als info op uw
                                    rekeningafschriften voor een </div>
                                <div class="">Belgische rekening, bestaat het IBAN uit 16 karakters, de BIC
                                    uit 8 of II karakters</div>
                                <div class="">Dit IBAN-nummer kan ook gebruikt worden voor de terugbetalling
                                    van alle bedragen in UW voordeel. </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                ...
                                {{-- <div class="row">
                            <div class="col-3">
                                <label for="client_5">Klantr.</label>
                            </div>
                            <div class="col-8">
                                <div class="form-group">
