                ...
                <div class="row">
                    <div class="col-6">
                        <div class="mb-2 container">
                            ...
                            <label for="want_luminus" class="mb-3 form-label mt-2"><b>Ik wil Luminus Comfy Pro</b><span
                                    class="text-danger">*</span></label>
                            @error('want_luminus')
                                <span class="invalid-feedback mb-2" role="alert">
                                    <strong>{{ $message }}</strong>
                    ...
                    <div class="col-6">
                        <div class="mb-2 container">
                            ...
                            <label for="want_luminus" class="mb-3 form-label mt-2"><b>Ik wil Luminus Comfyflex Pro</b><span
                                    class="text-danger">*</span></label>
                            @error('want_luminus')
                                <span class="invalid-feedback mb-2" role="alert">
                                    <strong>{{ $message }}</strong>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="mb-2 container">
                            ...
                            <label for="want_luminus_1" class="mb-3 form-label mt-2"><b>Ik wil Luminus Comfy Pro</b><span
                                    class="text-danger">*</span></label>
                    ...
                    <div class="col-6">
                        <div class="mb-2 container">
                            ...
                            <label for="want_luminus_1" class="mb-3 form-label mt-2"><b>IK wil Luminus ComfyFlex Pro</b><span
                                    class="text-danger">*</span></label>
                            @error('want_luminus_1')
                                <span class="invalid-feedback mb-2" role="alert">
                                    <strong>{{ $message }}</strong>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-5">
               ...
               <div class="row">
                   <div class="">Beschniving van onderliggend contract: <b>levering van energie</b></div>
               </div>
            </div>
        </div>
               <div class="row">
            ...
            <div class="col-7">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="">KuntuN IBAN rekeningnummer en BIC code als info op uw rekeningafschriften voor een </div>
                    <div class="">Belgische rekening, bestaat het IBAN uit 16 karakters, de BIC uit 8 of II karakters</div>
                <div class="">Dit IBAN-nummer kan ook gebruikt worden voor de terugbetalling van alle bedragen in UW voordeel. </div>
                </div>
                </div>
                <div class="row">
                    <div class="col-6">
