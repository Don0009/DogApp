    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-4">
                ...
                <div class="row">
                    <div class="col-5">
                        urniture d' energie a usage professionnel<label for="client_number" class="form-label"><b>N de client </b><span
            ...
            <div class="col-4">
                <div class="mb-2">
                    ...
                    <input type="number" class="form-control @error('present_to_luminus') is-invalid @enderror"
                        id="present_to_luminus" autocomplete="off" placeholder="Reserve A Luminius" name="present_to_luminus"
                ...
                <div class="col-10">
                    <div class="mb-2">
                        ...
                        <input type="number" class="form-control @error('client_number_1') is-invalid @enderror"
                            id="client_number" autocomplete="off" placeholder="Societe" name="client_number_1"
                            value="{{ old('client_number') }}" required>
                        @error('client_number')
                            <span class="invalid-feedback mb-2" role="alert">
                                <strong>{{ $message }}</strong>
        ...
        <div class="col-6">
            <div class="row">
                        ...
                        <div class="col-8">
                            <div class="mb-2">
                                ...
                                <input type="name" class="form-control @error('company_form') is-invalid @enderror"
                                    id="company_form" autocomplete="off" placeholder="Forme juridique" name="company_form"
                ...
                <div class="col-7">
                    <div class="row">
                        <div class="col-5">
                            <label for="mob_num" class="form-label"><b>Numerio d' enterprise <b> BE</b></b><span
                                class="text-danger">*</span></label>
                        </div>
                        <div class="col-7">
                            <div class="mb-2">
                                ...
                                <input type="name" class="form-control @error('company_number') is-invalid @enderror"
                                    id="company_number" autocomplete="off" placeholder="Numerio d' enterprise BE" name="company_number"
                            ...
                            <div class="col-10">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="name" class="form-control @error('nr_1') is-invalid @enderror"
                                        id="nr_1" autocomplete="off" placeholder="N" name="nr_1"
                            ...
                            <div class="col-10">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="name" class="form-control @error('deep') is-invalid @enderror"
                                        id="deep" autocomplete="off" placeholder="Etaqe" name="deep"
                        ...
                        <div class="col-10">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="name" class="form-control @error('post_code_1') is-invalid @enderror"
                                    id="post_code_1" autocomplete="off" placeholder="Code postal" name="post_code_1"
            ...
            <div class="col-6">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="mb-2 container">
                            ...
                            <label for="want_luminus" class="mb-3 form-label mt-2">Je souhaite Luminus Comfy Pro<span
                                    class="text-danger">*</span></label>
                            @error('want_luminus')
                                <span class="invalid-feedback mb-2" role="alert">
                                    <strong>{{ $message }}</strong>
                    ...
                    <div class="col-6">
                        <div class="mb-2 container">
                            ...
                            <label for="want_luminus" class="mb-3 form-label mt-2"><b>Je souhaite Luminus ComfyFlex Pro</b><span
                                    class="text-danger">*</span></label>
                            @error('want_luminus')
                                <span class="invalid-feedback mb-2" role="alert">
                                    <strong>{{ $message }}</strong>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="mb-2 container">
                            ...
                            <label for="existing_connection" class="mb-3 form-label mt-2">raccordenement existant<span
                                    class="text-danger">*</span></label>
                    ...
                    <div class="col-6">
                        <div class="mb-2 container">
                            ...
                            <label for="existing_connection" class="mb-3 form-label mt-2">nouveau raccordenement<span
                                    class="text-danger">*</span></label>
                            @error('existing_connection')
                                <span class="invalid-feedback mb-2" role="alert">
                                    <strong>{{ $message }}</strong>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="row">
                            <div class="col-3">
                                <b>Numero EAN(Ce numero figure sur les factures de votre fournisseur actuel et debute toujours par 54.)</b>
                            </div>
                            <div class="col-9">
                                <div class="mb-2">
                            ...
                            <div class="col-9">
                                <div class="mb-2">
                                    ...
                                    <input type="name" class="form-control @error('current_supplier') is-invalid @enderror"
                                        id="current_supplier" autocomplete="off" placeholder="Fournisseur actuel" name="current_supplier"
                            ...
                            <div class="col-9">
                                <div class="mb-2">
                                    ...
                                    <input type="name" class="form-control @error('name_your_network_operator') is-invalid @enderror"
                                        id="name_your_network_operator" autocomplete="off" placeholder="Nomk de votre gestionaire de reseau" name="name_your_network_operator"
                            ...
                            <div class="col-9">
                                <div class="mb-2">
                                    ...
                                    <input type="date" class="form-control @error('desired_switchover_date') is-invalid @enderror"
                                        id="desired_switchover_date" autocomplete="off" placeholder="Date souhantee de mise en service (JJ/MM/AAAA)" name="desired_switchover_date"
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="mb-2 container">
                            ...
                            <label for="want_luminus_1" class="mb-3 form-label mt-2"><b>Je souhaite Luminus Comfy Pro</b><span
                                    class="text-danger">*</span></label>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="mb-2 container">
                            ...
                            <label for="existing_connection_1" class="mb-3 form-label mt-2"><b>raccordement existant</b><span
                                    class="text-danger">*</span></label>
                    ...
                    <div class="col-6">
                        <div class="mb-2 container">
                            ...
                            <label for="existing_connection_1" class="mb-3 form-label mt-2">nouveau raccordement<span
                                    class="text-danger">*</span></label>
                            @error('existing_connection_1')
                                <span class="invalid-feedback mb-2" role="alert">
                                    <strong>{{ $message }}</strong>
                            ...
                            <div class="col-9">
                                <div class="mb-2">
                                    ...
                                    <input type="name" class="form-control @error('current_supplier_1') is-invalid @enderror"
                                        id="current_supplier_1" autocomplete="off" placeholder="Fournisseur actuel" name="current_supplier_1"
                            ...
                            <div class="col-9">
                                <div class="mb-2">
                                    ...
                                    <input type="date" class="form-control @error('desired_switchover_date_1') is-invalid @enderror"
                                        id="desired_switchover_date_1" autocomplete="off" placeholder="Date souhantee de mise en service (JJ/MM/AAAA):" name="desired_switchover_date_1"
  ...
  <div class="container-fluid">
    <div class="row">
        <div class="col-6">
            ...
            <div class="">(Toutes les informations figurent dans les conditions particulieres applicables au tarif que vous avez choisi. Si vous ne cochez rien ou si vous completez</div>
            <div class="">erronement votre avis avis de domiciliation, vous devrez automatiqurment payer par virement).</div>
            <div class="row">
                <div class="col-12">
                    <div class="mb-2 container">
                        <input type="radio" name="digitale" value="1" required>
                        <label for="digitale" class="mb-3 form-label mt-2"><b>Facture digitale</b> .Je recois toutes mes factures via email<span
                                class="text-danger">*</span></label>
                        @error('digitale')
                            <span class="invalid-feedback mb-2" role="alert">
                                <strong>{{ $message }}</strong>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="mb-2 container">
                        ...
                        <label for="domiciliering" class="mb-3 form-label mt-2"><b>Domiciliation.</b> pendat la duree de mon contract, mes factures seront debitees mensuellement de mon compte bancaire. La duree du mandat de domiciliation se limitee a la duree du contrat, y compris le dalai necessaire pour le traitement et le reglement de mon decompte.<b>Le mandat de domiciliation ci-dessous est d'application</b>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="mb-2 container">
                        ...
                        <label for="advance_invoices" class="mb-3 form-label mt-2">pour mes factures d'acompte et mes decomptes<span
                                class="text-danger">*</span></label>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="mb-2 container">
                        ...
                        <label for="my_advance_invoices" class="mb-3 form-label mt-2">uniqiement pour mes factures d'acompte et pour mes decomptes<span
                                class="text-danger">*</span></label>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                    <div class="mt-3">Le soussigne reconnait expressement avoir pris connaissance, avant la conclusion du present contract, des Condition generales au verso de ce contract et des COnditions patticulieres, les avoir comprises et acceptees.Le soussigne mandate Luminus pour entreprendre toutes les actions en son nom et pour son compte en vue du changement de fournisseur, en vue du raccordement au reseau et pour obtenir toutes les donnees (de consommation), y compris les donnees historiques, awes du gestionnaire de reseau.  </div>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
                    <div class="mt-3">Si nous ne vous notifions pas par ecrit, endeans les 20 jours ouvrables, que sur base de donnees objectives vous n'etes pas solvable, le contrat de foumiture devient definitif. </div>
                </div>
            </div>
        </div>
            </div>
            ...
            <div class="row">
                <div class="col-6">
                        ...
                        <div class="col-12">
                            <div class="mb-2">
                                ...
                                <input type="name" class="form-control @error('payment_for_electricity') is-invalid @enderror"
                                    id="payment_for_electricity" autocomplete="off" placeholder="Maandelijks voorschotbedrag electriciteit" name="payment_for_electricity"
                    ...
                    <div class="row">
                        ...
                        <div class="">Si la consommation pour I'addresse de furniture diverge, contactez-nous.</div>
                    </div>
                </div>
                <div class="col-6">
                    <div class="">
                                ...
                                <div class="col-12">
                                    <div class="mb-2">
                                        ...
                                        <input type="name" class="form-control @error('annual_consumption') is-invalid @enderror"
                                            id="annual_consumption" autocomplete="off" placeholder="Consommation annuelle* gaz" name="annual_consumption"
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="">Ce contrat n'et pas valable sans la signature du dient dans la case prevue a cet effet</div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class=""> Je m'engage a signaler a Luminus tout changement a ce sujet.</div>
                        <div class=""> Je declare que tons les points de livraison mentionnes dans ce contrat sont uniquement reserves a un usage professionnel, a I'exclusion de toute consommation domestique.</div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="mb-2 container">
                            ...
                            <label for="emails_or_text_messages" class="mb-3 form-label mt-2">Si vous ne souhaitez pas recevoir des e-maih ou SMS concemant des produits et services similaires au produit ou service vendu, veuillez cocher cette case. Pour plus d'informations, nous vous renvoyons vers notre site web-Mentions legales et politique de confidentialite. <span
                                    class="text-danger">*</span></label>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-5">
               ...
               <div class="row">
                   <div class="col-12">
                       <div class="mt-5">Description du contract correspondant: approvisionment en energie.</div>
               ...
               <div class="row">
                <div class="card">
                    <div class="card-body">
                   <div class="col-12">
                    En signant ce formulaire de mandat, vous autorisez (A) luminus SA a envoyer des instructions a votre banque pour debiter votre compte et (8) votre banque a debiter votre compte confor moment aux instructions de luminus
                   </div>
               </div>         </div>
            </div>
               <div class="row">
                <div class="card">
                    <div class="card-body">
                   <div class="col-12">
                    Vous btheficiez d'un droit de remboursement par votre banque selon les conditions Sites dans la convention que vous avez passee avec elle. Toute demande de remboursement doll etre presentee dans les S semaines suivant la date de debit de votre compte.
                   </div>
               </div>
            </div>
        </div>
                        ...
                        <div class="col-9">
                            <div class="form-group">
                                ...
                                <input required type="name" class="form-control" id="post_code_2"
                                    autocomplete="off" placeholder="Code Postal"
                                    name="post_code_2">
                            </div>
                        ...
                        <div class="col-11">
                            <div class="form-group">
                                ...
                                <input required type="name" class="form-control" id="stad"
                                    autocomplete="off" placeholder="Lieu"
                                    name="stad">
                            </div>
                            ...
                            <div class="col-10">
                                <div class="form-group">
                                    ...
                                    <input required type="name" class="form-control" id="land"
                                        autocomplete="off" placeholder="Pays"
                                        name="land">
                                </div>
