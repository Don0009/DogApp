                    ...
                    <table id="dataTableExample" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form class="d-inline-block" action="{{ route('internet_tv.destroy',$internet_tv->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                    ...
                                    <a href="{{ route('internet_tv.edit',$internet_tv->id) }}" class="btn btn-warning btn-icon-text">
                                        <i class="btn-icon-prepend" data-feather="edit"></i> Edit
                                    </a>
                                    <a href="{{ route('internet_tv.show',$internet_tv->id) }}" class="btn btn-success btn-icon-text">
