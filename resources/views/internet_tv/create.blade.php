                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="partner_apllication" autocomplete="off" placeholder="Referentie van de MyPartner aanvraag" name="partner_apllication">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="name" class="form-control" id="first_name" autocomplete="off" placeholder="First Name" name="first_name">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="mail" class="form-control" id="letter" autocomplete="off" placeholder="Letter" name="letter">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="name" class="form-control" id="customer_type" autocomplete="off" placeholder="Customer type:" name="customer_type">
                                </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="name" class="form-control" id="date_of_birth" autocomplete="off" placeholder="Geboortedatum" name="date_of_birth">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="name" class="form-control" id="place" autocomplete="off" placeholder="Plaat" name="place">
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="name" class="form-control" id="client_number" autocomplete="off" placeholder="CKlantnummer" name="client_number">
                                </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="call_number_1" autocomplete="off" placeholder="Call number" name="call_number_1">
                                </div>
                            </div>
                            <div class="col-6">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="call_number_9">In tweevoud opgemaakt te:</label>
                                    <input type="text" class="form-control" id="call_number_9" autocomplete="off" placeholder=" " name="call_number_9">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
...
>>>>>>> db8c1596289f3ec86e0344797cc8e59e30b3534b
