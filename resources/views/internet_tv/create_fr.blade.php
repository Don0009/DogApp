...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h2 class="card-title" style="text-align: center">Formulaire de demande d’installation Orange Internet + TV</h2>
                    <h4 class="card-title">Identification du demandeur et adresse d’installation</h4>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="partner_apllication" autocomplete="off"
                                                   placeholder="Référence de la demande MyPartner" name="partner_apllication">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="number" autocomplete="off"
                                                   placeholder="Numéro" name="number">
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="name" class="form-control" id="apartment_number" autocomplete="off"
                                                   placeholder="Numéro de l’appartement" name="apartment_number">
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="name" class="form-control" id="township" autocomplete="off"
                                                   placeholder="Localité" name="township">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="id_card_number" autocomplete="off"
                                                   placeholder="Numéro de carte d’identité " name="id_card_number">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="name_of_your_current_provider" autocomplete="off"
                                                   placeholder="Nom de votre fournisseur actuel pour les services Internet & TV :" name="name_of_your_current_provider">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="customer_number_at_your_current_supplier" autocomplete="off"
                                                   placeholder="Numéro de client chez votre fournisseur actuel pour les services Internet & TV (seulement si Telenet) :" name="customer_number_at_your_current_supplier">
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 mt-3" >
                                    <div class="text_orange">
                                        <span >Orange Belgium s.a.</span>
                                       </div>
                                       <div class="text_orange"> Avenue du Bourget | 1140 Bruxelles</div>
                                        ...
                                        <div class="text_orange">TVA  <span>BE 0456.810.810 |</span> RPR Brussel <span>www.orange.be</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <div class="migratiemandaat"> <h2>Mandat de migration pour services de ligne fixe et portabilité de numéro</h2>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="customer_number" autocomplete="off"
                                                   placeholder="Numéro de client :" name="customer_number">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="name" class="form-control" id="customer_type" autocomplete="off"
                                                   placeholder="Type de client :" name="customer_type">
                                        </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="name" class="form-control" id="language" autocomplete="off"
                                                   placeholder="Langue :" name="language">
                                        </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="name" class="form-control" id="number_identiteitskaart" autocomplete="off"
                                                   placeholder="Numéro de la carte d’identité :" name="number_identiteitskaart">
                                        </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="name" class="form-control" id="email_address" autocomplete="off"
                                                   placeholder="Adresse mail :" name="email_address">
                                        </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="name" class="form-control" id="number_1" autocomplete="off"
                                                   placeholder="Numéro :" name="number_1">
                                        </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="postcode_1" autocomplete="off"
                                                   placeholder="Code postale" name="postcode_1">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="vat_number" autocomplete="off"
                                                   placeholder="Numéro de TVA " name="vat_number">
                                        </div>
                                    </div>
                        ...
                        <div class="migratiemandaat">
                            ...
                            <div class="form-check" >
                                ...
                                <label class="form-check-label" for="flexCheckDefault" >
                                   <div class="default">
                                    <span style="font-weight: bold">Je souhaite utiliser</span> le service Easy Switch. Orange prend soin de la migration et de la résiliation
                                    mentionnée ci-dessous auprès de votre opérateur d’origine
                                   </div>
                                </label>
                              </div>
                              <div class="form-check" >
                                ...
                                <label class="form-check-label" for="flexCheckChecked">
                                    <div class="default">
                                        <span style="font-weight: bold">Je ne souhaite pas utiliser </span>le service Easy Switch.
                                        Je ferai moi-même le nécessaire pour résilier mes services de ligne fixe auprès de mon opérateur d’origine.
                                        Date d’installation souhaitée : date convenue avec le client.
                                       </div>
                                </label>
                              </div>
                        </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="operator_name" autocomplete="off"
                                                   placeholder="Nom de l’opérateur Easy Switch :" name="operator_name">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="name" class="form-control" id="client_number" autocomplete="off"
                                                   placeholder="Numéro de client :" name="client_number">
                                        </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="call_number_1" autocomplete="off"
                                                   placeholder="Numéro d’appel" name="call_number_1">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-check topper" >
                                            ...
                                            <label class="form-check-label" for="flexCheckDefault" >
                                               <div class="Stopping">
                                                <span style="">Supprimer (Uniquement applicable avec Easy Switch)
                                               </div>
                                            </label>
                                          </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="call_number_3" autocomplete="off"
                                                   placeholder="Numéro d’appel :" name="call_number_3">
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="form-check topper">
                                            ...
                                            <label class="form-check-label" for="flexCheckDefault">
                                               <div class="Stopping">
                                                <span style="">Transférer vers Orange</span>
                                               </div>
                                            </label>
                                          </div>
                                    ...
                                    <div class="col-3">
                                        <div class="form-check topper" >
                                            ...
                                            <label class="form-check-label" for="flexCheckDefault" >
                                               <div class="Stopping">
                                                <span style="">Supprimer
                                                    (Uniquement applicable avec Easy Switch)</span>
                                               </div>
                                            </label>
                                          </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="sim_number" autocomplete="off"
                                                   placeholder="Numéro SIM opérateur d’origine " name="sim_number">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="desired_transfer_date" autocomplete="off"
                                                   placeholder="Date de portage souhaitée " name="desired_transfer_date">
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="form-check topper">
                                    ...
                                    <div class="col-3">
                                        <div class="form-check topper">
                                            ...
                                            <label class="form-check-label" for="flexCheckDefault" >
                                               <div class="Stopping">
                                                <span style="">À la date d’installation
                                                    d’ Internet + TV</span>
                                               </div>
                                            </label>
                                          </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="sim_number_2" autocomplete="off"
                                                   placeholder="Numéro SIM opérateur d’origine  " name="sim_number_2">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="desired_transfer_date_1" autocomplete="off"
                                                   placeholder="Date de portage souhaitée " name="desired_transfer_date_1">
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="form-check topper">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="call_number_6" autocomplete="off"
                                                       placeholder="Numéro d’appel" name="call_number_6">
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="form-check topper">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="sim_number_3" autocomplete="off"
                                                       placeholder="Numéro SIM opérateur d’origine" name="sim_number_3">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="desired_transfer_date_2" autocomplete="off"
                                                       placeholder="Date de portage souhaitée" name="desired_transfer_date_2">
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="form-check topper">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="call_number_7" autocomplete="off"
                                                       placeholder="Numéro d’appel" name="call_number_7">
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="form-check topper">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="sim_number_4" autocomplete="off"
                                                       placeholder="Numéro SIM opérateur d’origine" name="sim_number_4">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="transfer_date_3" autocomplete="off"
                                                       placeholder="Date de portage souhaitée" name="transfer_date_3">
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="form-check topper">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="call_number_8" autocomplete="off"
                                                       placeholder="Numéro d’appel" name="call_number_8">
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="form-check topper">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="sim_number_5" autocomplete="off"
                                                       placeholder="Numéro SIM opérateur d’origine " name="sim_number_5">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="desired_transfer_date_4" autocomplete="off"
                                                       placeholder="Date de portage souhaitée" name="desired_transfer_date_4">
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="form-check topper">
                                                ...
                                                <label class="form-check-label" for="flexCheckDefault">
                                                   <div class="Stopping">Immédiatement
                                                    <span style="">*</span>
                                                   </div>
                                                </label>
                                              </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="call_number_9" autocomplete="off"
                                                   placeholder="Etabli en deux exemplaires à" name="call_number_9">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" id="file_1" autocomplete="off"
                                                   placeholder="Signature" name="file_1">
                                        </div>
                                    </div>
