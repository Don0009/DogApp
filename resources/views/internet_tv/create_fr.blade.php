                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="partner_apllication" autocomplete="off" placeholder="Référence de la demande MyPartner" name="partner_apllication">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="name" class="form-control" id="name" autocomplete="off" placeholder="Nom" name="name">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="first_name">Prénom :</label>
                                        <input required type="name" class="form-control" id="first_name" autocomplete="off" placeholder="Prénom" name="first_name">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="name" class="form-control" id="street" autocomplete="off" placeholder="Rue" name="street">
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        <label for="number">Numéro :</label>
                                        <input required type="number" class="form-control" id="number" autocomplete="off" placeholder="Numéro" name="number">
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        <label for="letter">Lettre :</label>
                                        <input required type="mail" class="form-control" id="letter" autocomplete="off" placeholder="Lettre" name="letter">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="name" class="form-control" id="apartment_number" autocomplete="off" placeholder="Numéro de l’appartement" name="apartment_number">
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        <label for="floor">Etage :</label>
                                        <input required type="name" class="form-control" id="floor" autocomplete="off" placeholder="Etage" name="floor">
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        <label for="bus">Boîte :</label>
                                        <input required type="name" class="form-control" id="bus" autocomplete="off" placeholder="Boîte" name="bus">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="name" class="form-control" id="township" autocomplete="off" placeholder="Localité" name="township">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="postcode">Code postal :</label>
                                        <input required type="name" class="form-control" id="postcode" autocomplete="off" placeholder="Code postal " name="postcode">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input required type="name" class="form-control" id="gsm" autocomplete="off" placeholder="Gsm" name="gsm">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="mail" class="form-control" id="mail" autocomplete="off" placeholder="Mail" name="mail">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="id_card_number">Numéro de carte d’identité :</label>
                                        <input required type="text" class="form-control" id="id_card_number" autocomplete="off" placeholder="Numéro de carte d’identité " name="id_card_number">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="orange_customer_number" autocomplete="off" placeholder="N° de client Orange :" name="orange_customer_number">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="name_of_your_current_provider" autocomplete="off" placeholder="Nom de votre fournisseur actuel pour les services Internet & TV :" name="name_of_your_current_provider">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="customer_number_at_your_current_supplier" autocomplete="off" placeholder="Numéro de client chez votre fournisseur actuel pour les services Internet & TV (seulement si Telenet) :" name="customer_number_at_your_current_supplier">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input required type="date" class="form-control" id="id_card_number_d1" autocomplete="off" placeholder="DATES AND TIMES " name="id_card_number_d1">
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input required type="date" class="form-control" id="id_card_number_d2" autocomplete="off" placeholder="DATES AND TIMES " name="id_card_number_d2">
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input required type="date" class="form-control" id="id_card_number_d3" autocomplete="off" placeholder="DATES AND TIMES" name="id_card_number_d3">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="customer_number" autocomplete="off" placeholder="Numéro de client :" name="customer_number">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="customer_type">Type de client :</label>
                                        <input required type="name" class="form-control" id="customer_type" autocomplete="off" placeholder="Type de client :" name="customer_type">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="title" autocomplete="off" placeholder="Titre :" name="title">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="language">Langue :</label>
                                        <input required type="name" class="form-control" id="language" autocomplete="off" placeholder="Langue :" name="language">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="first_name_1" autocomplete="off" placeholder="Prénom :" name="first_name_1">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="name_1">Nom :</label>
                                        <input required type="name" class="form-control" id="name_1" autocomplete="off" placeholder="Nom :" name="name_1">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="date" class="form-control" id="date_of_birth" autocomplete="off" placeholder="Date de naissance" name="date_of_birth">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="number_identiteitskaart">Numéro de la carte d’identité :</label>
                                        <input required type="name" class="form-control" id="number_identiteitskaart" autocomplete="off" placeholder="Numéro de la carte d’identité :" name="number_identiteitskaart">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="telephone" autocomplete="off" placeholder="Téléphone :" name="telephone">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="email_address">Adresse mail :</label>
                                        <input required type="name" class="form-control" id="email_address" autocomplete="off" placeholder="Adresse mail :" name="email_address">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="street_1" autocomplete="off" placeholder="Rue :" name="street_1">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="number_1">Numéro :</label>
                                        <input required type="name" class="form-control" id="number_1" autocomplete="off" placeholder="Numéro :" name="number_1">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="postcode_1" autocomplete="off" placeholder="Code postale" name="postcode_1">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="place">Localité :</label>
                                        <input required type="name" class="form-control" id="place" autocomplete="off" placeholder="Localité" name="place">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="vat_number" autocomplete="off" placeholder="Numéro de TVA " name="vat_number">
                                    </div>
                                </div>
                            ...
                            <div class="row pt-3 mb-3 border border-dark">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="operator_name" autocomplete="off" placeholder="Nom de l’opérateur Easy Switch :" name="operator_name">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="client_number">Numéro de client :</label>
                                        <input required type="name" class="form-control" id="client_number" autocomplete="off" placeholder="Numéro de client :" name="client_number">
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="easy_switch_id" autocomplete="off" placeholder="Easy Switch ID :" name="easy_switch_id">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row pt-3 mb-3 border border-dark">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="call_number_1" autocomplete="off" placeholder="Numéro d’appel" name="call_number_1">
                                    </div>
                                </div>
                                <div class="col-6">
                            ...
                            <div class="row pt-3 mb-3 border border-dark">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="call_number_2" autocomplete="off" placeholder="Call number" name="call_number_2">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-check topper">
                            ...
                            <div class="row pt-3 mb-3 border border-dark">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="call_number_3" autocomplete="off" placeholder="Numéro d’appel :" name="call_number_3">
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-check topper">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="sim_number" autocomplete="off" placeholder="Numéro SIM opérateur d’origine " name="sim_number">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="original_operator">Opérateur d’origine :</label>
                                        <input required type="text" class="form-control" id="original_operator" autocomplete="off" placeholder="Opérateur d’origine" name="original_operator">
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="desired_transfer_date" autocomplete="off" placeholder="Date de portage souhaitée " name="desired_transfer_date">
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-check topper">
                            ...
                            <div class="row pt-3 mb-3 border border-dark">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="call_number_5" autocomplete="off" placeholder="Oproepnummer" name="call_number_5">
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-check topper">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="sim_number_2" autocomplete="off" placeholder="Numéro SIM opérateur d’origine  " name="sim_number_2">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="original_operator_1">Opérateur d’origine :</label>
                                        <input required type="text" class="form-control" id="original_operator_1" autocomplete="off" placeholder="Opérateur d’origine  " name="original_operator_1">
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="desired_transfer_date_1" autocomplete="off" placeholder="Date de portage souhaitée " name="desired_transfer_date_1">
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-check topper">
                            ...
                            <div class="row pt-3 mb-3 border border-dark">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="call_number_6" autocomplete="off" placeholder="Numéro d’appel" name="call_number_6">
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-check topper">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="sim_number_3" autocomplete="off" placeholder="Numéro SIM opérateur d’origine" name="sim_number_3">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="original_operator_2">Opérateur d’origine :</label>
                                        <input required type="text" class="form-control" id="original_operator_2" autocomplete="off" placeholder="Opérateur d’origine" name="original_operator_2">
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="desired_transfer_date_2" autocomplete="off" placeholder="Date de portage souhaitée" name="desired_transfer_date_2">
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-check topper">
                            ...
                            <div class="row pt-3 mb-3 border border-dark">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="call_number_7" autocomplete="off" placeholder="Numéro d’appel" name="call_number_7">
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-check topper">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="sim_number_4" autocomplete="off" placeholder="Numéro SIM opérateur d’origine" name="sim_number_4">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="original_operator_3">Opérateur d’origine :</label>
                                        <input required type="text" class="form-control" id="original_operator_3" autocomplete="off" placeholder="Oorspronkelijke operator" name="original_operator_3">
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="transfer_date_3" autocomplete="off" placeholder="Date de portage souhaitée" name="transfer_date_3">
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-check topper">
                            ...
                            <div class="row pt-3 mb-3 border border-dark">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="call_number_8" autocomplete="off" placeholder="Numéro d’appel" name="call_number_8">
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-check topper">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="sim_number_5" autocomplete="off" placeholder="Numéro SIM opérateur d’origine " name="sim_number_5">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="original_operator_4">Opérateur d’origine :</label>
                                        <input required type="text" class="form-control" id="original_operator_4" autocomplete="off" placeholder="Opérateur d’origine" name="original_operator_4">
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="desired_transfer_date_4" autocomplete="off" placeholder="Date de portage souhaitée" name="desired_transfer_date_4">
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-check topper">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="call_number_9" autocomplete="off" placeholder="Etabli en deux exemplaires à" name="call_number_9">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="op">le :</label>
                                        <input required type="text" class="form-control" id="op" autocomplete="off" placeholder="on" name="op">
                                    </div>
