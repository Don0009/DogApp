                            ...
                            <div class="section">
                                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="professional_client">
                                          ...
                                          <div class="col-10">
                                            <div class="form-group">
                                                <input type="email" class="form-control" id="email" autocomplete="off"
                                                       placeholder="E-email" name="email">
                                            </div>
                                          </div>
                                      </div>
                                        </div>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <input type="name" class="form-control" id="document_id" autocomplete="off"
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-12 mt-3">
                                    <input type="name" class="form-control" id="représentée_par_1" autocomplete="off"
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-12">
                                                <div class="row">
                                                    <div class="col-1">
                                                        <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="residential_customer_1">
                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="madame_1">
                                                <label class="form-check-label" for="inlineCheckbox2">Madame</label>
                                              </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="monsieur_1">
                                                <label class="form-check-label" for="inlineCheckbox2">Monsieur</label>
                                              </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-2">
                                                            <label for="first_last_name_1">Nom/Prénom</label>
                                                        </div>
                                                        <div class="col-10">
                                                            <input type="name" class="form-control" id="first_last_name_1" autocomplete="off"
                                                            placeholder="Nom/Prénom" name="first_last_name_1">
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-2">
                                                        <label for="customer_no_2">N° de Client</label>
                                                    </div>
                                                    <div class="col-10">
                                                        <input type="number" class="form-control" id="customer_no_2" autocomplete="off"
                                                        placeholder="N° de Client" name="customer_no_2">
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <label for="date_of_birth_1">Date de naissance</label>
                                                    </div>
                                                    <div class="col-6">
                                                        <input type="date" class="form-control" id="date_of_birth_1" autocomplete="off"
                                                           placeholder="Date de naissance" name="date_of_birth_1">
                                                </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <label for="place_of_birth_1">Lieu de naissance</label>
                                                    </div>
                                                    <div class="col-6">
                                                        <input type="date" class="form-control" id="place_of_birth_1" autocomplete="off"
                                                       placeholder="Lieu de naissance" name="place_of_birth_1">
                                                </div>
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <input type="name" class="form-control" id="company_name_1" autocomplete="off"
                                                           placeholder="Date de naissance" name="company_name_1">
                                                </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <label for="legal_status_1">Forme juridique</label>
                                                    </div>
                                                    <div class="col-6">
                                                        <input type="name" class="form-control" id="legal_status_1" autocomplete="off"
                                                       placeholder="Lieu de naissance" name="legal_status_1">
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-5">
                                                        <label for="customer_no_3">N° de Client</label>
                                                    </div>
                                                    <div class="col-7">
                                                        <input type="number" class="form-control" id="customer_no_3" autocomplete="off"
                                                        placeholder="N° de Client" name="customer_no_3">
                                                </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-4">
                                                        <label for="code_nace_1">Code NACE</label>
                                                    </div>
                                                    <div class="col-8">
                                                        <input type="name" class="form-control" id="code_nace_1" autocomplete="off"
                                                       placeholder="Code NACE" name="code_nace_1">
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-3">
                                                        <label for="tva_be_1">TVA BE</label>
                                                    </div>
                                                    <div class="col-9">
                                                        <input type="name" class="form-control" id="tva_be_1" autocomplete="off"
                                                        placeholder="TVA BE" name="tva_be_1">
                                                </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-2">
                                                        <label for="rpm_1">RPM</label>
                                                    </div>
                                                    <div class="col-10">
                                                        <input type="name" class="form-control" id="rpm_1" autocomplete="off"
                                                        placeholder="RPM" name="rpm_1">
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-2">
                                                        <label for="phone_1">Tél</label>
                                                    </div>
                                                    <div class="col-10">
                                                        <input type="number" class="form-control" id="phone_1" autocomplete="off"
                                                        placeholder="Tél" name="phone_1">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-2">
                                                        <label for="gsm_1">GSM</label>
                                                    </div>
                                                    <div class="col-10">
                                                        <input type="name" class="form-control" id="gsm_1" autocomplete="off"
                                                       placeholder="GSM" name="gsm_1">
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-10">
                                            <div class="form-group">
                                                <input type="email" class="form-control" id="email_1" autocomplete="off"
                                                       placeholder="E-mail" name="email_1">
                                            </div>
                                          </div>
                                      </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="you_wish_to_be_kept_informed_1">
                                                <label class="form-check-label" for="inlineCheckbox2">Vous souhaitez être tenu au courant par e-mail du lancement de nouveaux produits, services, promotions et
                                                    autres actions d’ENGIE Electrabel</label>
                                              </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="you_wish_to_receive_communications_1">
                                                <label class="form-check-label" for="inlineCheckbox2">Vous souhaitez recevoir les communications concernant votre (vos) contrat(s) avec ENGIE Electrabel par e-mail
                                                    (voir aussi les Conditions Spécifiques)</label>
                                              </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-1">
                                              <label for="rue_2">Rue</label>

                                        </div>
                                        <div class="col-11">
                                          <div class="form-group">
                                              <input type="name" class="form-control" id="rue_2" autocomplete="off"
                                                     placeholder="E-mail" name="rue_2">
                                          </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-2">
                                            <div class="form-group">
                                             <div class="row">
                                                <div class="col-3">
                                                    <label for="noo_2">N°</label>
                                                </div>
                                                <div class="col-9">
                                                    <input type="name" class="form-control" id="noo_2" autocomplete="off"
                                                    placeholder="N°" name="noo_2">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-2">
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-3">
                                                        <label for="bte_2">Bte</label>
                                                    </div>
                                                    <div class="col-9">
                                                        <input type="name" class="form-control" id="bte_2" autocomplete="off"
                                                        placeholder="Bte" name="bte_2">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="row">
                                                        <div class="col-4">
                                                            <label for="etage_2">Etage</label>
                                                        </div>
                                                        <div class="col-8">
                                                            <input type="name" class="form-control" id="etage_2" autocomplete="off"
                                                            placeholder="Etage" name="etage_2">
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-5">
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-5">
                                                        <label for="appartement_2">Appartement</label>
                                                    </div>
                                                    <div class="col-7">
                                                        <input type="name" class="form-control" id="appartement_2" autocomplete="off"
                                                        placeholder="Appartement" name="appartement_2">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-5">
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-7">
                                                        <input type="name" class="form-control" id="code_postal_2" autocomplete="off"
                                                        placeholder="Code postal" name="code_postal_2">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-7">
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-2">
                                                        <label for="localité_2">Localité</label>
                                                    </div>
                                                    <div class="col-10">
                                                        <input type="name" class="form-control" id="localité_2" autocomplete="off"
                                                        placeholder="Code postal" name="localité_2">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                 ...
                 <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-4">
                                    <label for="document_id_1">Document ID:</label>
                                </div>
                                <div class="col-8">
                                    <input type="name" class="form-control" id="document_id_2" autocomplete="off"
                                    placeholder="Document ID" name="document_id_2">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-12 mt-3">
                                    <input type="name" class="form-control" id="représentée_par_1" autocomplete="off"
                                    placeholder="Représentée par:www.engie-electrabel.be • Ligne Home Services : 078 35 33 34" name="représentée_par_2">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 mt-5">
                                    <div class="">Dénommée ci après « nous » ou « ENGIE Electrabel »</div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-2">
                    <div class="row">
                        <div class="col-2">
                            <label for="rue_3">Rue</label>

                      </div>
                      <div class="col-10">
                        <div class="form-group">
                            <input type="email" class="form-control" id="rue_3" autocomplete="off"
                                   placeholder="E-mail" name="rue_3">
                        </div>
                      </div>
                   </div>
                </div>
                ...
                <div class="col-2">
                    <div class="form-group">
                     <div class="row">
                        <div class="col-2">
                            <label for="noo_3">N°</label>
                        </div>
                        <div class="col-10">
                            <input type="name" class="form-control" id="noo_3" autocomplete="off"
                            placeholder="N°" name="noo_3">
                        </div>
                    </div>
                </div>
            </div>
        <div class="col-2">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-2">
                                <label for="bte_3">Bte</label>
                            </div>
                            <div class="col-10">
                                <input type="name" class="form-control" id="bte_3" autocomplete="off"
                                placeholder="Bte" name="bte_3">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-2">
                    <div class="form-group">
                        <div class="row">
                            <div class="row">
                                <div class="col-2">
                                    <label for="etage_3">Etage</label>
                                </div>
                                <div class="col-10">
                                    <input type="name" class="form-control" id="etage_3" autocomplete="off"
                                    placeholder="Etage" name="etage_3">
                                </div>
                            </div>
                ...
                <div class="col-2">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-3">
                                <label for="appartement_3">Appartement</label>
                            </div>
                            <div class="col-9">
                                <input type="name" class="form-control" id="appartement_3" autocomplete="off"
                                placeholder="Appartement" name="appartement_3">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-2">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-5">
                                <label for="code_postal_3">Code postal</label>
                            </div>
                            <div class="col-7">
                                <input type="name" class="form-control" id="code_postal_3" autocomplete="off"
                                placeholder="Code postal" name="code_postal_3">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-3">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-3">
                                <label for="localité_3">Localité</label>
                            </div>
                            <div class="col-9">
                                <input type="name" class="form-control" id="localité_3" autocomplete="off"
                                placeholder="Code postal" name="localité_3">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-6">
                                    <label for="year_of_first_use_3">Année de première utilisation du bâtiment suite à sa construction (4)</label>
                                </div>
                                <div class="col-6">
                                    <input type="name" class="form-control" id="year_of_first_use_3" autocomplete="off"
                                    placeholder="Code postal" name="year_of_first_use_3">
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="section">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="you_are_a_customer_of_engie_3">
                    <label class="form-check-label" for="inlineCheckbox2">Vous êtes client chez ENGIE Electrabel pour la fourniture d’énergie. Le service vous est facturé par le biais d’un montant mensuel fixe sur votre facture d’énergie, durant la période d’entretien.</label>
                  </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-3">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="oil_installation_3">
                    <label class="form-check-label" for="inlineCheckbox2">Installation au mazout</label>
                  </div>
            </div>
            <div class="col-3">
        ...
        <div class="row">
            <div class="col-3">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="gas_installation_3">
                    <label class="form-check-label" for="inlineCheckbox2">Installation au gaz, poêles au gaz individuels</label>
                  </div>
                </div>
                  <div class="col-3">
        ...
        <div class="row">
            <div class="col-3">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="electrical_installation_3">
                    <label class="form-check-label" for="inlineCheckbox2">Installation à l’électricité</label>
                  </div>
                </div>
                  <div class="col-3">
        ...
        <div class="row">
            <div class="col-12">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="you_are_not_customer_of_engie_electrabel_3">
                    <label class="form-check-label" for="inlineCheckbox2">Vous n’êtes pas client chez ENGIE Electrabel pour la fourniture d’énergie. Vous devez alors nous payer le montant en une seule fois après que l’entretien ait été effectué</label>
                  </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-3">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="oil_installation_4">
                    <label class="form-check-label" for="inlineCheckbox2">Installation au mazout</label>
                  </div>
            </div>
            <div class="col-3">
        ...
        <div class="row">
            <div class="col-3">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="gas_installation_4">
                    <label class="form-check-label" for="inlineCheckbox2">Installation au gaz, poêles au gaz individuels</label>
                  </div>
                </div>
                  <div class="col-3">
        ...
        <div class="row">
            <div class="col-3">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="electrical_installation_4">
                    <label class="form-check-label" for="inlineCheckbox2">Installation à l’électricité</label>
                  </div>
                </div>
                  <div class="col-3">
                        ...
                        <div class="">* Pour les poêles à gaz individuels, sont compris dans le service deux poêles de votre choix. Pour les
                            ...
                            <div class="">
                                <label class="form-check-label" for="inlineCheckbox2">(1) Si vous ne souhaitez pas recevoir nos offres promotionnelles, vous pouvez vous y opposer sans frais en
                                    cochant cette case</label>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="if_you_do_not_wish_to_receive_3">
                                  </div>
                            </div>
                            <div class="">(2) A remplir uniquement si vous êtes déjà client d’ENGIE Electrabel</div>
                            <div class="">(3) A compléter si différente de l’adresse d’installation.</div>
            ...
            <div class="col-md-6 grid-margin stretch-card mt-5">
                <div class="card">
                    <div class="card-body">
                     ...
                     <div class="row">
                        <div class="col-8">
                            <label for="drawn_up_3">Etabli en trois exemplaires originaux, à</label>
                        </div>
                        <div class="col-4">
                            <div class="form-group">
                                <input type="name" class="form-control" id="drawn_up_3" autocomplete="off"
                                       placeholder="Etabli en trois exemplaires originaux, à" name="drawn_up_3">
                            </div>
                        </div>
                     </div>
                        <div class="row">
                                ...
                                <div class="col-1">
                                    <label for="the_3">le</label></div>
                                <div class="col-5">
                                    <input type="date" class="form-control" id="the_3" autocomplete="off"
                                    placeholder="le" name="the_3">
                                </div>
                                <div class="col-6">
                                    <label for="">, dont vous reconnaissez avoir reçu un exemplaire.</label>
                                </div>
...
pas de dettes ouvertes auprès d’ENGIE Electrabel.
                        ...
                        <div class="row mt-5">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="of_which_you_acknowledge_3">Wim Van de Velde</label>
                                    <label for="of_which_you_acknowledge_3">Responsable</label>
                                    <label for="of_which_you_acknowledge_3">Service Clientèle</label>
                                    <input type="name" class="form-control" id="of_which_you_acknowledge_3" autocomplete="off"
                                           placeholder="le" name="of_which_you_acknowledge_3">, dont vous reconnaissez avoir reçu un exemplaire.
                                </div>
                            </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="to_the_customer_3">Pour le Client :</label>
                                        <input type="name" class="form-control" id="to_the_customer_3" autocomplete="off"
                                               placeholder="Nom :.............[Signature]" name="to_the_customer_3">
                                    </div>
                                </div>
                        </div>
